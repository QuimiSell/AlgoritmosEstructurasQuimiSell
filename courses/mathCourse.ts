...
export const MATH_COURSE: Course = {
  ...
  modules: [{
      ...
      description: "El cimiento de la programación y los circuitos digitales. Tablas de verdad, condicionales y De Morgan. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE.",
      items: [
      ...
      content: "## 📘 Clase completa — LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEl cimiento de la programación y los circuitos digitales. Tablas de verdad, condicionales y De Morgan. Para un Ingeniero en Sistemas, la Lógica Matemática es la herramienta para construir y verificar algoritmos correctos. La sentencia 'if' en un lenguaje de programación evalúa una proposición lógica a Verdadero (1) o Falso (0). La Implicación (P → Q) rige las precondiciones y postcondiciones en arquitectura de software. Las Leyes de De Morgan (¬(P ∧ Q) ≡ ¬P ∨ ¬Q) se utilizan a diario en refactorización de código para transformar condicionales complejas y difíciles de mantener en expresiones limpias y legibles.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Proposiciones y Sentencias de Control de Software.\n· Conectores Lógicos: AND (∧), OR (∨), NOT (¬), Implicación (→) y XOR (⊕).\n· Tablas de Verdad y Evaluación de Expresiones Booleanas.\n· Leyes de De Morgan para la simplificación de código condicional.\n· Tautologías, Contradicciones y Circuitos Lógicos de Hardware.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Proposiciones y Sentencias de Control de Software.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Proposiciones y Sentencias de Control de Software.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Proposiciones y Sentencias de Control de Software.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Conectores Lógicos: AND (∧), OR (∨), NOT (¬), Implicación (→) y XOR (⊕).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Conectores Lógicos: AND (∧), OR (∨), NOT (¬), Implicación (→) y XOR (⊕).» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Conectores Lógicos: AND (∧), OR (∨), NOT (¬), Implicación (→) y XOR (⊕).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Tablas de Verdad y Evaluación de Expresiones Booleanas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Tablas de Verdad y Evaluación de Expresiones Booleanas.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Tablas de Verdad y Evaluación de Expresiones Booleanas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Leyes de De Morgan para la simplificación de código condicional.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Leyes de De Morgan para la simplificación de código condicional.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Leyes de De Morgan para la simplificación de código condicional.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Tautologías, Contradicciones y Circuitos Lógicos de Hardware.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Tautologías, Contradicciones y Circuitos Lógicos de Hardware.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Tautologías, Contradicciones y Circuitos Lógicos de Hardware.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 2:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 3:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar LÓGICA MATEMÁTICA Y ÁLGEBRA DE BOOLE es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Modelado de colecciones de datos, operaciones de conjuntos y su aplicación en bases de datos SQL. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL.",
      items: [
      ...
      content: "## 📘 Clase completa — TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nModelado de colecciones de datos, operaciones de conjuntos y su aplicación en bases de datos SQL. Las Bases de Datos Relacionales (SQL) están completamente construidas sobre la Teoría de Conjuntos de Edgar F. Codd. Una tabla es un conjunto de tuplas. Una consulta INNER JOIN calcula la intersección A ∩ B entre dos tablas basándose en una clave de coincidencia. La operación UNION equivale a A ∪ B, mientras que EXCEPT realiza la diferencia de conjuntos A \\\\\\\\ B. Comprender la cardinalidad del Producto Cartesiano |A × B| = |A| · |B| advierte al ingeniero sobre los peligros de consultas SQL sin cláusula JOIN, las cuales saturan el servidor.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Conjuntos: Extensión, Comprensión y Cardinalidad |A|.\n· Operaciones de Conjuntos: Unión (∪), Intersección (∩), Diferencia (\\) y Complemento.\n· El Producto Cartesiano A × B y la operación CROSS JOIN en bases de datos.\n· Mapeo de Operaciones de Conjuntos a Consultas SQL (UNION, INTERSECT, EXCEPT).\n· Diagramas de Venn y Conjunto Potencia P(A) de 2ⁿ elementos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Conjuntos: Extensión, Comprensión y Cardinalidad |A|.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Conjuntos: Extensión, Comprensión y Cardinalidad |A|.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Conjuntos: Extensión, Comprensión y Cardinalidad |A|.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Operaciones de Conjuntos: Unión (∪), Intersección (∩), Diferencia (\\) y Complemento.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Operaciones de Conjuntos: Unión (∪), Intersección (∩), Diferencia (\\) y Complemento.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Operaciones de Conjuntos: Unión (∪), Intersección (∩), Diferencia (\\) y Complemento.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — El Producto Cartesiano A × B y la operación CROSS JOIN en bases de datos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El Producto Cartesiano A × B y la operación CROSS JOIN en bases de datos.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El Producto Cartesiano A × B y la operación CROSS JOIN en bases de datos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Mapeo de Operaciones de Conjuntos a Consultas SQL (UNION, INTERSECT, EXCEPT).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapeo de Operaciones de Conjuntos a Consultas SQL (UNION, INTERSECT, EXCEPT).» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapeo de Operaciones de Conjuntos a Consultas SQL (UNION, INTERSECT, EXCEPT).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Diagramas de Venn y Conjunto Potencia P(A) de 2ⁿ elementos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diagramas de Venn y Conjunto Potencia P(A) de 2ⁿ elementos.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diagramas de Venn y Conjunto Potencia P(A) de 2ⁿ elementos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 2:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 3:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar TEORÍA DE CONJUNTOS Y ÁLGEBRA RELACIONAL es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Mapeos de entrada y salida, funciones puras, inyectivas, biyectivas y composición. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE.",
      items: [
      ...
      content: "## 📘 Clase completa — RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nMapeos de entrada y salida, funciones puras, inyectivas, biyectivas y composición. En la arquitectura de software moderna (y en particular en Programación Funcional), una Función Pura es un mapeo matemático estricto: dada una entrada x del dominio, siempre produce la misma salida y del codominio sin efectos secundarios. Una función es Inyectiva si no existen dos entradas diferentes mapeadas al mismo destino (crucial para funciones Hash sin colisiones). Si una función es Biyectiva, admite una Función Inversa f⁻¹, lo cual permite construir sistemas de encriptación y desencriptación reversibles.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Relaciones Binarias y Propiedades: Reflexiva, Simétrica y Transitiva.\n· Relaciones de Equivalencia y Algoritmo Union-Find (DSU).\n· Funciones f: X → Y: Dominio, Codominio y Rango.\n· Funciones Inyectivas (Uno a Uno), Sobreyectivas (Sobre) y Biyectivas.\n· Composición de Funciones (f ∘ g)(x) y Funciones Inversas f⁻¹.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Relaciones Binarias y Propiedades: Reflexiva, Simétrica y Transitiva.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Relaciones Binarias y Propiedades: Reflexiva, Simétrica y Transitiva.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Relaciones Binarias y Propiedades: Reflexiva, Simétrica y Transitiva.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Relaciones de Equivalencia y Algoritmo Union-Find (DSU).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Relaciones de Equivalencia y Algoritmo Union-Find (DSU).» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Relaciones de Equivalencia y Algoritmo Union-Find (DSU).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Funciones f: X → Y: Dominio, Codominio y Rango.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Funciones f: X → Y: Dominio, Codominio y Rango.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Funciones f: X → Y: Dominio, Codominio y Rango.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Funciones Inyectivas (Uno a Uno), Sobreyectivas (Sobre) y Biyectivas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Funciones Inyectivas (Uno a Uno), Sobreyectivas (Sobre) y Biyectivas.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Funciones Inyectivas (Uno a Uno), Sobreyectivas (Sobre) y Biyectivas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Composición de Funciones (f ∘ g)(x) y Funciones Inversas f⁻¹.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Composición de Funciones (f ∘ g)(x) y Funciones Inversas f⁻¹.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Composición de Funciones (f ∘ g)(x) y Funciones Inversas f⁻¹.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 2:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 3:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar RELACIONES, FUNCIONES Y ARQUITECTURA DE SOFTWARE es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Representación de datos a bajo nivel en la CPU: Binario, Hexadecimal y Complemento a 2. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE.",
      items: [
      ...
      content: "## 📘 Clase completa — SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nRepresentación de datos a bajo nivel en la CPU: Binario, Hexadecimal y Complemento a 2. A nivel de hardware, una computadora solo manipula voltajes digitales representados por 0s y 1s. Los ingenieros en sistemas leen direcciones de memoria en Hexadecimal (base 16) porque cada dígito hex representa exactamente 4 bits (nibble). El formato Complemento a 2 es el estándar de procesadores x86/ARM para representar enteros negativos, ya que permite realizar la resta A - B mediante un circuito de suma A + (-B). Los operadores bitwise permiten activar, desactivar y consultar permisos (flags) en tiempo de ejecución de $O(1)$.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Bases Numéricas: Decimal (10), Binario (2), Octal (8) y Hexadecimal (16).\n· Algoritmos de Conversión de Base y Punteros de Memoria (0x...)\n· Representación de Enteros Negativos: Complemento a 2 en la ALU.\n· Operadores Bitwise: AND (&), OR (|), XOR (^), NOT (~) y Shifts (<<, >>).\n· Máscaras de Bits y Banderas de Estado (Bitmasks & Flags).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Bases Numéricas: Decimal (10), Binario (2), Octal (8) y Hexadecimal (16).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Bases Numéricas: Decimal (10), Binario (2), Octal (8) y Hexadecimal (16).» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Bases Numéricas: Decimal (10), Binario (2), Octal (8) y Hexadecimal (16).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Algoritmos de Conversión de Base y Punteros de Memoria (0x...)\n\nTiempo sugerido al grabar: **7–9 minutos**. «Algoritmos de Conversión de Base y Punteros de Memoria (0x...)» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Algoritmos de Conversión de Base y Punteros de Memoria (0x...)» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Representación de Enteros Negativos: Complemento a 2 en la ALU.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Representación de Enteros Negativos: Complemento a 2 en la ALU.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Representación de Enteros Negativos: Complemento a 2 en la ALU.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Operadores Bitwise: AND (&), OR (|), XOR (^), NOT (~) y Shifts (<<, >>).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Operadores Bitwise: AND (&), OR (|), XOR (^), NOT (~) y Shifts (<<, >>).» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Operadores Bitwise: AND (&), OR (|), XOR (^), NOT (~) y Shifts (<<, >>).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Máscaras de Bits y Banderas de Estado (Bitmasks & Flags).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Máscaras de Bits y Banderas de Estado (Bitmasks & Flags).» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Máscaras de Bits y Banderas de Estado (Bitmasks & Flags).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 2:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 3:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar SISTEMAS NUMÉRICOS Y OPERACIONES BITWISE es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Modelado de redes, caminos óptimos, árboles de decisión y matrices de adyacencia. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS.",
      items: [
      ...
      content: "## 📘 Clase completa — MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nModelado de redes, caminos óptimos, árboles de decisión y matrices de adyacencia. La Teoría de Grafos es la rama discreta por excelencia en la carrera de Sistemas. Una red de computadoras, una red social (Facebook), el mapa de carreteras de Waze o el árbol de dependencias de `npm` son grafos G = (V, E). La Matriz de Adyacencia A(n×n) almacena si existe una arista entre los vértices i y j. Algoritmos como Dijkstra o A* resuelven el camino de menor costo en redes ponderadas, mientras que BFS calcula la ruta con menor número de saltos en tiempo $O(V + E)$.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Definición de Grafo G = (V, E): Dirigidos, No Dirigidos y Ponderados.\n· Representación de Grafos: Lista de Adyacencia vs Matriz de Adyacencia.\n· Caminos, Ciclos y Grado de un Vértice.\n· Árboles: Árboles Generadores Mínimos (Kruskal y Prim).\n· Algoritmos de Recorrido: Búsqueda en Anchura (BFS) y Profundidad (DFS).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Definición de Grafo G = (V, E): Dirigidos, No Dirigidos y Ponderados.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición de Grafo G = (V, E): Dirigidos, No Dirigidos y Ponderados.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición de Grafo G = (V, E): Dirigidos, No Dirigidos y Ponderados.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Representación de Grafos: Lista de Adyacencia vs Matriz de Adyacencia.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Representación de Grafos: Lista de Adyacencia vs Matriz de Adyacencia.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Representación de Grafos: Lista de Adyacencia vs Matriz de Adyacencia.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Caminos, Ciclos y Grado de un Vértice.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Caminos, Ciclos y Grado de un Vértice.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Caminos, Ciclos y Grado de un Vértice.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Árboles: Árboles Generadores Mínimos (Kruskal y Prim).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Árboles: Árboles Generadores Mínimos (Kruskal y Prim).» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Árboles: Árboles Generadores Mínimos (Kruskal y Prim).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Algoritmos de Recorrido: Búsqueda en Anchura (BFS) y Profundidad (DFS).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Algoritmos de Recorrido: Búsqueda en Anchura (BFS) y Profundidad (DFS).» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Algoritmos de Recorrido: Búsqueda en Anchura (BFS) y Profundidad (DFS).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 2:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 3:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar MATEMÁTICA DISCRETA Y TEORÍA DE GRAFOS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Operaciones matriciales, gráficos 2D/3D, vectores y modelos de Inteligencia Artificial. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN.",
      items: [
      ...
      content: "## 📘 Clase completa — ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nOperaciones matriciales, gráficos 2D/3D, vectores y modelos de Inteligencia Artificial. El Álgebra Lineal es la columna vertebral de la informática gráfica y el aprendizaje profundo (Deep Learning). La multiplicación de matrices A(m×n) × B(n×p) proyecta transformaciones de espacio. En videojuegos 3D, una matriz de transformaciones 4×4 posiciona, rota y escala modelos poligonales en pantalla. En Inteligencia Artificial (LLMs), los Embeddings de texto representan palabras como vectores de números de alta dimensión, calculando su similitud mediante el Producto Escalar u · v.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Matrices M(m×n): Filas, Columnas y Elementos a_ij.\n· Suma, Resta, Multiplicación por Escalar y Multiplicación de Matrices A×B.\n· Matriz Identidad, Transpuesta Aᵀ y Determinantes 2x2/3x3.\n· Transformaciones Geométricas 2D/3D (Rotación, Escalado y Traslación).\n· Vectores, Producto Escalar (Dot Product) y Embeddings de Inteligencia Artificial.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Matrices M(m×n): Filas, Columnas y Elementos a_ij.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Matrices M(m×n): Filas, Columnas y Elementos a_ij.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Matrices M(m×n): Filas, Columnas y Elementos a_ij.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Suma, Resta, Multiplicación por Escalar y Multiplicación de Matrices A×B.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Suma, Resta, Multiplicación por Escalar y Multiplicación de Matrices A×B.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Suma, Resta, Multiplicación por Escalar y Multiplicación de Matrices A×B.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Matriz Identidad, Transpuesta Aᵀ y Determinantes 2x2/3x3.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Matriz Identidad, Transpuesta Aᵀ y Determinantes 2x2/3x3.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Matriz Identidad, Transpuesta Aᵀ y Determinantes 2x2/3x3.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Transformaciones Geométricas 2D/3D (Rotación, Escalado y Traslación).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Transformaciones Geométricas 2D/3D (Rotación, Escalado y Traslación).» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Transformaciones Geométricas 2D/3D (Rotación, Escalado y Traslación).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Vectores, Producto Escalar (Dot Product) y Embeddings de Inteligencia Artificial.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Vectores, Producto Escalar (Dot Product) y Embeddings de Inteligencia Artificial.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Vectores, Producto Escalar (Dot Product) y Embeddings de Inteligencia Artificial.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 2:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 3:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ÁLGEBRA LINEAL Y MATRICES EN COMPUTACIÓN es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Razones trigonométricas, funciones periódicas y física para videojuegos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar TRIGONOMETRÍA Y SIMULACIÓN FÍSICA.",
      items: [
      ...
      content: "## 📘 Clase completa — TRIGONOMETRÍA Y SIMULACIÓN FÍSICA\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nRazones trigonométricas, funciones periódicas y física para videojuegos. En desarrollo de software de juegos, gráficos y robótica, la Trigonometría traduce ángulos de rotación a coordenadas X, Y en pantalla. La función `math.atan2(y, x)` es fundamental en código para hacer que un personaje u objeto gire apuntando hacia la posición del cursor del mouse. Las funciones Seno y Coseno producen oscilaciones suaves continuas entre -1 y 1, utilizadas para animar respiración de personajes, movimiento de olas y procesamiento de audio digital.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Grados Sexagesimales vs Radianes (π rad = 180°).\n· Funciones Trigonométricas: Seno, Coseno y Tangente.\n· Identidad Trigonométrica Fundamental: sin²(θ) + cos²(θ) = 1.\n· Cálculo de Ángulos con Arcotangente 2 (atan2(y, x)) en desarrollo de software.\n· Ondas Sinusoidales y Funciones Periódicas para animaciones.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de TRIGONOMETRÍA Y SIMULACIÓN FÍSICA.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Grados Sexagesimales vs Radianes (π rad = 180°).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Grados Sexagesimales vs Radianes (π rad = 180°).» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Grados Sexagesimales vs Radianes (π rad = 180°).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Funciones Trigonométricas: Seno, Coseno y Tangente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Funciones Trigonométricas: Seno, Coseno y Tangente.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Funciones Trigonométricas: Seno, Coseno y Tangente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Identidad Trigonométrica Fundamental: sin²(θ) + cos²(θ) = 1.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Identidad Trigonométrica Fundamental: sin²(θ) + cos²(θ) = 1.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Identidad Trigonométrica Fundamental: sin²(θ) + cos²(θ) = 1.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Cálculo de Ángulos con Arcotangente 2 (atan2(y, x)) en desarrollo de software.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Cálculo de Ángulos con Arcotangente 2 (atan2(y, x)) en desarrollo de software.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Cálculo de Ángulos con Arcotangente 2 (atan2(y, x)) en desarrollo de software.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Ondas Sinusoidales y Funciones Periódicas para animaciones.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ondas Sinusoidales y Funciones Periódicas para animaciones.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ondas Sinusoidales y Funciones Periódicas para animaciones.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de TRIGONOMETRÍA Y SIMULACIÓN FÍSICA.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de TRIGONOMETRÍA Y SIMULACIÓN FÍSICA.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de TRIGONOMETRÍA Y SIMULACIÓN FÍSICA.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en TRIGONOMETRÍA Y SIMULACIÓN FÍSICA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 2:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 3:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume TRIGONOMETRÍA Y SIMULACIÓN FÍSICA en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar TRIGONOMETRÍA Y SIMULACIÓN FÍSICA es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Exponentes, logaritmos y fundamentación matemática del análisis de algoritmos Big-O. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO.",
      items: [
      ...
      content: "## 📘 Clase completa — ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nExponentes, logaritmos y fundamentación matemática del análisis de algoritmos Big-O. El análisis de algoritmos se apoya directamente en el comportamiento de las funciones logarítmicas y exponenciales. Un algoritmo con complejidad $O(\\\\\\\\log n)$ (como la Búsqueda Binaria) reduce el problema a la mitad en cada paso. Para $n = 1,000,000$ de elementos, un algoritmo lineal $O(n)$ realiza 1,000,000 de operaciones, mientras que uno logarítmico $O(\\\\\\\\log_2 n)$ realiza solo 20 comparaciones. Comprender el crecimiento analítico permite elegir las mejores estructuras de datos.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Propiedades de Exponentes y Radicales.\n· Logaritmos: Definición log_b(x) = y ⇔ b^y = x.\n· Propiedades Logarítmicas: log(A·B), log(A/B) y Cambio de Base.\n· Inecuaciones y Cotas Matemáticas f(n) ≤ c · g(n).\n· Demostración Formal de la Notación Big-O, Big-Omega y Theta.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Propiedades de Exponentes y Radicales.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Propiedades de Exponentes y Radicales.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Propiedades de Exponentes y Radicales.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Logaritmos: Definición log_b(x) = y ⇔ b^y = x.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Logaritmos: Definición log_b(x) = y ⇔ b^y = x.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Logaritmos: Definición log_b(x) = y ⇔ b^y = x.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Propiedades Logarítmicas: log(A·B), log(A/B) y Cambio de Base.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Propiedades Logarítmicas: log(A·B), log(A/B) y Cambio de Base.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Propiedades Logarítmicas: log(A·B), log(A/B) y Cambio de Base.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Inecuaciones y Cotas Matemáticas f(n) ≤ c · g(n).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inecuaciones y Cotas Matemáticas f(n) ≤ c · g(n).» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inecuaciones y Cotas Matemáticas f(n) ≤ c · g(n).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Demostración Formal de la Notación Big-O, Big-Omega y Theta.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Demostración Formal de la Notación Big-O, Big-Omega y Theta.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Demostración Formal de la Notación Big-O, Big-Omega y Theta.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 2:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\n**Caso 3:** SQL es álgebra relacional: JOIN, GROUP BY y agregaciones tienen fundamento en conjuntos.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ÁLGEBRA ANALÍTICA Y CRECIMIENTO LOGARÍTMICO es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Razones de cambio instantáneas, derivadas y el algoritmo Descenso de Gradiente. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE.",
      items: [
      ...
      content: "## 📘 Clase completa — CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nRazones de cambio instantáneas, derivadas y el algoritmo Descenso de Gradiente. El Cálculo Diferencial es la herramienta para optimizar software y modelos de Inteligencia Artificial. La Derivada f'(x) mide la tasa de cambio de una función. En redes neuronales, el algoritmo de Descenso de Gradiente busca los pesos óptimos ajustando los parámetros en la dirección opuesta al Gradiente ∇f de la función de error. Encontrar los puntos críticos (donde la derivada f'(x) = 0) permite calcular la máxima eficiencia o el menor costo operativo de un sistema de software.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Concepto de Límite lim x→a f(x) y Continuidad de funciones.\n· Definición de la Derivada f'(x) como razón de cambio instantánea.\n· Reglas de Derivación: Potencia, Suma, Producto, Cociente y Cadena.\n· Optimización de Funciones: Puntos Mínimos y Máximos (f'(x) = 0).\n· El Gradiente ∇f y Descenso de Gradiente en Machine Learning.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Concepto de Límite lim x→a f(x) y Continuidad de funciones.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Concepto de Límite lim x→a f(x) y Continuidad de funciones.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Concepto de Límite lim x→a f(x) y Continuidad de funciones.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Definición de la Derivada f'(x) como razón de cambio instantánea.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición de la Derivada f'(x) como razón de cambio instantánea.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición de la Derivada f'(x) como razón de cambio instantánea.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Reglas de Derivación: Potencia, Suma, Producto, Cociente y Cadena.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Reglas de Derivación: Potencia, Suma, Producto, Cociente y Cadena.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Reglas de Derivación: Potencia, Suma, Producto, Cociente y Cadena.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Optimización de Funciones: Puntos Mínimos y Máximos (f'(x) = 0).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Optimización de Funciones: Puntos Mínimos y Máximos (f'(x) = 0).» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Optimización de Funciones: Puntos Mínimos y Máximos (f'(x) = 0).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — El Gradiente ∇f y Descenso de Gradiente en Machine Learning.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El Gradiente ∇f y Descenso de Gradiente en Machine Learning.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El Gradiente ∇f y Descenso de Gradiente en Machine Learning.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 2:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\n**Caso 3:** Motores 3D aplican matrices de rotación/escala en cada frame de renderizado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar CÁLCULO DIFERENCIAL Y OPTIMIZACIÓN EN SOFTWARE es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Conteo discreto, Teorema Maestro para algoritmos recursivos y aritmética modular para cifrado RSA. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA.",
      items: [
      ...
      content: "## 📘 Clase completa — COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nConteo discreto, Teorema Maestro para algoritmos recursivos y aritmética modular para cifrado RSA. Este módulo conecta la matemática avanzada directamente con la ciberseguridad y el diseño algorítmico. Las Combinaciones C(n,k) determinan el espacio de claves posibles de un sistema criptográfico. El Teorema Maestro resuelve la complejidad asintótica de algoritmos recursivos de Divide y Vencerás como Merge Sort T(n) = 2T(n/2) + O(n) → O(n log n). La Aritmética Modular a mod m sostiene toda la infraestructura de seguridad en internet (HTTPS/SSL, SSH) mediante la dificultad de factorizar números primos gigantes en el cifrado RSA.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Principios Combinatorios: Regla de la Suma y del Producto.\n· Permutaciones P(n, k) y Combinaciones C(n, k).\n· Ecuaciones de Recurrencia T(n) = aT(n/b) + f(n) y Teorema Maestro.\n· Aritmética Modular: a ≡ b (mod m) y Algoritmo de Euclides (MCD).\n· Cifrado Asimétrico RSA y Teoría de Números Primos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Principios Combinatorios: Regla de la Suma y del Producto.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Principios Combinatorios: Regla de la Suma y del Producto.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Principios Combinatorios: Regla de la Suma y del Producto.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Permutaciones P(n, k) y Combinaciones C(n, k).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Permutaciones P(n, k) y Combinaciones C(n, k).» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Permutaciones P(n, k) y Combinaciones C(n, k).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Ecuaciones de Recurrencia T(n) = aT(n/b) + f(n) y Teorema Maestro.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ecuaciones de Recurrencia T(n) = aT(n/b) + f(n) y Teorema Maestro.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ecuaciones de Recurrencia T(n) = aT(n/b) + f(n) y Teorema Maestro.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Aritmética Modular: a ≡ b (mod m) y Algoritmo de Euclides (MCD).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aritmética Modular: a ≡ b (mod m) y Algoritmo de Euclides (MCD).» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aritmética Modular: a ≡ b (mod m) y Algoritmo de Euclides (MCD).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Cifrado Asimétrico RSA y Teoría de Números Primos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Cifrado Asimétrico RSA y Teoría de Números Primos.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Cifrado Asimétrico RSA y Teoría de Números Primos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA dentro de fundamentos matemáticos aplicados a software, bases de datos e IA.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 2:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\n**Caso 3:** Backpropagation en redes neuronales es la regla de la cadena del cálculo multivariado.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar COMBINATORIA, RECURRENCIA Y CRIPTOGRAFÍA es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
