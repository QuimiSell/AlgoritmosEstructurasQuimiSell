...
export const CLEAN_CODE_COURSE: Course = {
  ...
  modules: [{
      ...
      description: "Las enseñanzas de Robert C. Martin (Tío Bob): código autodocumentado, nombres intencionados y la regla del Boy Scout. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS.",
      items: [
      ...
      content: "## 📘 Clase completa — FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nLas enseñanzas de Robert C. Martin (Tío Bob): código autodocumentado, nombres intencionados y la regla del Boy Scout. Robert C. Martin (Tío Bob) abre su célebre libro 'Clean Code' con una verdad irrefutable: la proporción de tiempo dedicada a leer código frente a escribirlo es de más de 10 a 1. Escribir nombres expresivos como `dias_desde_ultimo_modificacion` en lugar de `d` le ahorra a tus compañeros (y a ti mismo en el futuro) horas de adivinanza. La Regla del Boy Scout exige que en cada commit dejas el módulo ligeramente mejor estructurado de como lo encontraste.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· El costo real del código desordenado y la deuda técnica.\n· Nombres con intención reveladora (Evitar variables a1, temp, data).\n· Hacer distinciones con sentido y evitar desinformación.\n· Nombres pronunciables y buscables en la base de código.\n· La Regla del Boy Scout: 'Deja el campamento más limpio de como lo encontraste'.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — El costo real del código desordenado y la deuda técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El costo real del código desordenado y la deuda técnica.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El costo real del código desordenado y la deuda técnica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Nombres con intención reveladora (Evitar variables a1, temp, data).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Nombres con intención reveladora (Evitar variables a1, temp, data).» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Nombres con intención reveladora (Evitar variables a1, temp, data).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Hacer distinciones con sentido y evitar desinformación.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Hacer distinciones con sentido y evitar desinformación.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Hacer distinciones con sentido y evitar desinformación.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Nombres pronunciables y buscables en la base de código.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Nombres pronunciables y buscables en la base de código.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Nombres pronunciables y buscables en la base de código.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — La Regla del Boy Scout: 'Deja el campamento más limpio de como lo encontraste'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «La Regla del Boy Scout: 'Deja el campamento más limpio de como lo encontraste'.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «La Regla del Boy Scout: 'Deja el campamento más limpio de como lo encontraste'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 2:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 3:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar FILOSOFÍA CLEAN CODE Y NOMBRES EXPRESIVOS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Reglas para escribir funciones pequeñas, el principio de nivel único de abstracción y el uso de excepciones. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES.",
      items: [
      ...
      content: "## 📘 Clase completa — FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nReglas para escribir funciones pequeñas, el principio de nivel único de abstracción y el uso de excepciones. La primera regla de las funciones de Tío Bob es: deben ser pequeñas. La segunda regla es: deben ser AÚN más pequeñas. Una función debe realizar una sola tarea y hacerla bien. Cuando le pasas un booleano como parámetro a una función (ej: `procesar_usuario(usuario, es_admin=True)`), estás indicando implícitamente que la función hace dos cosas distintas según la bandera. Se deben dividir en dos funciones independientes: `procesar_usuario_normal` y `procesar_usuario_admin`.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Las funciones deben ser PEQUEÑAS (idealmente de menos de 10-15 líneas).\n· Hacer UNA sola cosa (Single Responsibility a nivel de función).\n· Un solo nivel de abstracción por función (Single Level of Abstraction).\n· Evitar argumentos de bandera (Flag Arguments booleanos).\n· Usar Excepciones en lugar de retornar códigos de error nulos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Las funciones deben ser PEQUEÑAS (idealmente de menos de 10-15 líneas).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Las funciones deben ser PEQUEÑAS (idealmente de menos de 10-15 líneas).» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Las funciones deben ser PEQUEÑAS (idealmente de menos de 10-15 líneas).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Hacer UNA sola cosa (Single Responsibility a nivel de función).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Hacer UNA sola cosa (Single Responsibility a nivel de función).» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Hacer UNA sola cosa (Single Responsibility a nivel de función).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Un solo nivel de abstracción por función (Single Level of Abstraction).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Un solo nivel de abstracción por función (Single Level of Abstraction).» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Un solo nivel de abstracción por función (Single Level of Abstraction).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Evitar argumentos de bandera (Flag Arguments booleanos).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Evitar argumentos de bandera (Flag Arguments booleanos).» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Evitar argumentos de bandera (Flag Arguments booleanos).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Usar Excepciones en lugar de retornar códigos de error nulos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Usar Excepciones en lugar de retornar códigos de error nulos.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Usar Excepciones en lugar de retornar códigos de error nulos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 2:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 3:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar FUNCIONES, PARÁMETROS Y MANEJO DE ERRORES es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Cuándo los comentarios son un síntoma de mal código, formato vertical/horizontal y la ley de la claridad. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar COMENTARIOS Y FORMATO DE CÓDIGO.",
      items: [
      ...
      content: "## 📘 Clase completa — COMENTARIOS Y FORMATO DE CÓDIGO\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nCuándo los comentarios son un síntoma de mal código, formato vertical/horizontal y la ley de la claridad. Tío Bob afirma: 'Los comentarios son, en el mejor de los casos, un mal necesario. Cada vez que escribes un comentario, deberías sentir que has fallado en expresarte mediante el código'. Los comentarios suelen mentir porque el código evoluciona y nadie actualiza los comentarios. En lugar de escribir `# Comprueba si el usuario tiene más de 18 años`, extrae esa condición a una función llamada `es_mayor_de_edad()`. El formato vertical debe leerse como un periódico: el concepto de alto nivel arriba y los detalles abajo.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· El mito del código comentado: 'No comentes mal código, reescríbelo'.\n· Comentarios verdaderamente necesarios (Legal, advertencia de consecuencias, TODOs legítimos).\n· Comentarios ruidosos, redundantes y obsoletos.\n· Formato Vertical: La metáfora del periódico (de lo general a lo específico).\n· Formato Horizontal: Anchura de líneas y sangrado transparente.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de COMENTARIOS Y FORMATO DE CÓDIGO.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — El mito del código comentado: 'No comentes mal código, reescríbelo'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El mito del código comentado: 'No comentes mal código, reescríbelo'.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El mito del código comentado: 'No comentes mal código, reescríbelo'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Comentarios verdaderamente necesarios (Legal, advertencia de consecuencias, TODOs legítimos).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Comentarios verdaderamente necesarios (Legal, advertencia de consecuencias, TODOs legítimos).» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Comentarios verdaderamente necesarios (Legal, advertencia de consecuencias, TODOs legítimos).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Comentarios ruidosos, redundantes y obsoletos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Comentarios ruidosos, redundantes y obsoletos.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Comentarios ruidosos, redundantes y obsoletos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Formato Vertical: La metáfora del periódico (de lo general a lo específico).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Formato Vertical: La metáfora del periódico (de lo general a lo específico).» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Formato Vertical: La metáfora del periódico (de lo general a lo específico).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Formato Horizontal: Anchura de líneas y sangrado transparente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Formato Horizontal: Anchura de líneas y sangrado transparente.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Formato Horizontal: Anchura de líneas y sangrado transparente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de COMENTARIOS Y FORMATO DE CÓDIGO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de COMENTARIOS Y FORMATO DE CÓDIGO.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de COMENTARIOS Y FORMATO DE CÓDIGO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en COMENTARIOS Y FORMATO DE CÓDIGO dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 2:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 3:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume COMENTARIOS Y FORMATO DE CÓDIGO en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar COMENTARIOS Y FORMATO DE CÓDIGO es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Una sola razón para cambiar. Alta cohesión, bajo acoplamiento y separación de aspectos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP).",
      items: [
      ...
      content: "## 📘 Clase completa — PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nUna sola razón para cambiar. Alta cohesión, bajo acoplamiento y separación de aspectos. El Primer Principio SOLID es el **Single Responsibility Principle (SRP)**. La definición del Tío Bob es muy específica: 'Un módulo debe ser responsable ante un solo actor de negocio'. Si una clase `ReporteEmpleado` calcula el salario para Finanzas y además imprime el formato PDF para Recursos Humanos, tiene DOS razones para cambiar. Si Finanzas cambia el cálculo de horas extra, podrías romper accidentalmente la impresión de RRHH. SRP exige separar estas responsabilidades en clases independientes.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Definición exacta de SRP: 'Un módulo o clase debe tener una y solo una razón para cambiar'.\n· Identificación de 'razones para cambiar' asociadas a actores de negocio.\n· Separación de la Lógica de Negocio de la Lógica de Persistencia / UI.\n· Síntomas de violación de SRP: Clases Dios (God Classes) y archivos gigantes.\n· Cohesión: El grado en que los métodos de una clase trabajan sobre sus atributos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Definición exacta de SRP: 'Un módulo o clase debe tener una y solo una razón para cambiar'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición exacta de SRP: 'Un módulo o clase debe tener una y solo una razón para cambiar'.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición exacta de SRP: 'Un módulo o clase debe tener una y solo una razón para cambiar'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Identificación de 'razones para cambiar' asociadas a actores de negocio.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Identificación de 'razones para cambiar' asociadas a actores de negocio.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Identificación de 'razones para cambiar' asociadas a actores de negocio.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Separación de la Lógica de Negocio de la Lógica de Persistencia / UI.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Separación de la Lógica de Negocio de la Lógica de Persistencia / UI.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Separación de la Lógica de Negocio de la Lógica de Persistencia / UI.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Síntomas de violación de SRP: Clases Dios (God Classes) y archivos gigantes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Síntomas de violación de SRP: Clases Dios (God Classes) y archivos gigantes.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Síntomas de violación de SRP: Clases Dios (God Classes) y archivos gigantes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Cohesión: El grado en que los métodos de una clase trabajan sobre sus atributos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Cohesión: El grado en que los métodos de una clase trabajan sobre sus atributos.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Cohesión: El grado en que los métodos de una clase trabajan sobre sus atributos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP).» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 2:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 3:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PRINCIPIO S - SINGLE RESPONSIBILITY PRINCIPLE (SRP) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Abierto para extensión, cerrado para modificación. Uso de interfaces y polimorfismo. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP).",
      items: [
      ...
      content: "## 📘 Clase completa — PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nAbierto para extensión, cerrado para modificación. Uso de interfaces y polimorfismo. El segundo principio SOLID es el **Open/Closed Principle (OCP)**. Afirma que deberías poder extender el comportamiento de un sistema SIN modificar su código fuente existente ya probado y en producción. Si para agregar un nuevo método de pago (ej: PayPal) tienes que modificar la clase `ProcesadorPagos` agregando un `else if (tipo == 'PAYPAL')`, estás violando OCP. La solución es crear una interfaz `MetodoPago` y agregar una nueva clase `PagoPayPal` que la implemente.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Definición de OCP: 'Las entidades de software deben estar abiertas para extensión, pero cerradas para modificación'.\n· El peligro de agregar nuevos tipos editando bloques `switch` / `if-else` existentes.\n· Uso de Abstracciones (Interfaces y Clases Abstractas) para lograr OCP.\n· Inyección de nuevos comportamientos creando nuevas clases sin alterar el código probado.\n· Relación entre OCP y los Patrones de Diseño (Strategy, Decorator).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Definición de OCP: 'Las entidades de software deben estar abiertas para extensión, pero cerradas para modificación'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición de OCP: 'Las entidades de software deben estar abiertas para extensión, pero cerradas para modificación'.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición de OCP: 'Las entidades de software deben estar abiertas para extensión, pero cerradas para modificación'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — El peligro de agregar nuevos tipos editando bloques `switch` / `if-else` existentes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El peligro de agregar nuevos tipos editando bloques `switch` / `if-else` existentes.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El peligro de agregar nuevos tipos editando bloques `switch` / `if-else` existentes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Uso de Abstracciones (Interfaces y Clases Abstractas) para lograr OCP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Uso de Abstracciones (Interfaces y Clases Abstractas) para lograr OCP.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Uso de Abstracciones (Interfaces y Clases Abstractas) para lograr OCP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Inyección de nuevos comportamientos creando nuevas clases sin alterar el código probado.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inyección de nuevos comportamientos creando nuevas clases sin alterar el código probado.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inyección de nuevos comportamientos creando nuevas clases sin alterar el código probado.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Relación entre OCP y los Patrones de Diseño (Strategy, Decorator).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Relación entre OCP y los Patrones de Diseño (Strategy, Decorator).» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Relación entre OCP y los Patrones de Diseño (Strategy, Decorator).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP).» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 2:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\n**Caso 3:** Spring y NestJS implementan inversión de dependencias de forma nativa.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PRINCIPIO O - OPEN/CLOSED PRINCIPLE (OCP) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Sustituibilidad de subclases, contratos de interfaz, precondiciones y postcondiciones. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP).",
      items: [
      ...
      content: "## 📘 Clase completa — PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nSustituibilidad de subclases, contratos de interfaz, precondiciones y postcondiciones. El tercer principio SOLID es el **Liskov Substitution Principle (LSP)**, formulado por Barbara Liskov. Establece que los objetos de una clase derivada deben poder sustituir a los objetos de la clase base sin que el programa falle o se comporte erróneamente. El ejemplo clásico es la clase `Cuadrado` heredando de `Rectangulo`. Si un método cambia el ancho del rectángulo esperando que el alto no cambie, y el Cuadrado altera ambas dimensiones a la vez, se violan los contratos de LSP.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Definición de Barbara Liskov (1987) para subtipado de datos.\n· Si S es un subtipo de T, los objetos de tipo T deben poder reemplazarse por objetos de tipo S sin alterar la corrección del programa.\n· El dilema clásico del Cuadrado y el Rectángulo.\n· Reglas de Contrato: Precondiciones no pueden ser reforzadas en la subclase.\n· Postcondiciones y la preservación de invariantes.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Definición de Barbara Liskov (1987) para subtipado de datos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición de Barbara Liskov (1987) para subtipado de datos.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición de Barbara Liskov (1987) para subtipado de datos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Si S es un subtipo de T, los objetos de tipo T deben poder reemplazarse por objetos de tipo S sin alterar la corrección del programa.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Si S es un subtipo de T, los objetos de tipo T deben poder reemplazarse por objetos de tipo S sin alterar la corrección del programa.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Si S es un subtipo de T, los objetos de tipo T deben poder reemplazarse por objetos de tipo S sin alterar la corrección del programa.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — El dilema clásico del Cuadrado y el Rectángulo.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El dilema clásico del Cuadrado y el Rectángulo.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El dilema clásico del Cuadrado y el Rectángulo.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Reglas de Contrato: Precondiciones no pueden ser reforzadas en la subclase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Reglas de Contrato: Precondiciones no pueden ser reforzadas en la subclase.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Reglas de Contrato: Precondiciones no pueden ser reforzadas en la subclase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Postcondiciones y la preservación de invariantes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Postcondiciones y la preservación de invariantes.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Postcondiciones y la preservación de invariantes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP).» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 2:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 3:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PRINCIPIO L - LISKOV SUBSTITUTION PRINCIPLE (LSP) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Interfaces específicas para cada cliente (ISP) e Inversión de Dependencias mediante inyección (DIP). Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION.",
      items: [
      ...
      content: "## 📘 Clase completa — PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nInterfaces específicas para cada cliente (ISP) e Inversión de Dependencias mediante inyección (DIP). Los últimos dos principios SOLID son **ISP** y **DIP**. **ISP** enseña que es preferible tener muchas interfaces pequeñas y especializadas en lugar de una interfaz gigante con decenas de métodos no relacionados. **DIP** establece la regla de oro de la arquitectura limpia: 'Los módulos de alto nivel (lógica de negocio) no deben depender de módulos de bajo nivel (DB, UI, HTTP); ambos deben depender de abstracciones'. Al inyectar la interfaz de la base de datos por el constructor, la lógica de negocio se vuelve independiente del motor SQL o NoSQL.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Interface Segregation Principle (ISP): 'Ningún cliente debe ser forzado a depender de métodos que no usa'.\n· Diseño de interfaces enfocadas y de granularidad fina.\n· Dependency Inversion Principle (DIP): Módulos de alto nivel no deben depender de módulos de bajo nivel.\n· Ambos deben depender de Abstracciones (Interfaces).\n· Inyección de Dependencias (DI): Constructor Injection y contenedores IoC.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Interface Segregation Principle (ISP): 'Ningún cliente debe ser forzado a depender de métodos que no usa'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Interface Segregation Principle (ISP): 'Ningún cliente debe ser forzado a depender de métodos que no usa'.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Interface Segregation Principle (ISP): 'Ningún cliente debe ser forzado a depender de métodos que no usa'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Diseño de interfaces enfocadas y de granularidad fina.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diseño de interfaces enfocadas y de granularidad fina.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diseño de interfaces enfocadas y de granularidad fina.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Dependency Inversion Principle (DIP): Módulos de alto nivel no deben depender de módulos de bajo nivel.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Dependency Inversion Principle (DIP): Módulos de alto nivel no deben depender de módulos de bajo nivel.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Dependency Inversion Principle (DIP): Módulos de alto nivel no deben depender de módulos de bajo nivel.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Ambos deben depender de Abstracciones (Interfaces).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ambos deben depender de Abstracciones (Interfaces).» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ambos deben depender de Abstracciones (Interfaces).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Inyección de Dependencias (DI): Constructor Injection y contenedores IoC.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inyección de Dependencias (DI): Constructor Injection y contenedores IoC.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inyección de Dependencias (DI): Constructor Injection y contenedores IoC.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 2:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 3:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PRINCIPIOS I Y D - INTERFACE SEGREGATION & DEPENDENCY INVERSION es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Mecanismos de creación de objetos flexibles: Singleton, Factory Method, Abstract Factory, Builder y Prototype. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR).",
      items: [
      ...
      content: "## 📘 Clase completa — PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nMecanismos de creación de objetos flexibles: Singleton, Factory Method, Abstract Factory, Builder y Prototype. Los Patrones Creacionales abstraen el proceso de instanciación de objetos. El patrón **Factory Method** define una interfaz para crear un objeto, permitiendo a las subclases decidir qué clase concreta instanciar. El patrón **Builder** separa la construcción de un objeto complejo de su representación (ideal para evitar constructores con 10 parámetros). El patrón **Singleton** asegura que una clase tenga una única instancia en todo el sistema (aunque debe usarse con precaución para no crear un estado global acoplado).\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Origen de los Patrones de Diseño (Libro GoF - Gang of Four 1994).\n· Patrón Singleton: Garantizar una única instancia global y cuándo EVITARLO.\n· Patrón Factory Method: Delegar la instanciación a subclases especializadas.\n· Patrón Abstract Factory: Familias de objetos relacionados.\n· Patrón Builder: Construcción paso a paso de objetos complejos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Origen de los Patrones de Diseño (Libro GoF - Gang of Four 1994).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Origen de los Patrones de Diseño (Libro GoF - Gang of Four 1994).» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Origen de los Patrones de Diseño (Libro GoF - Gang of Four 1994).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Patrón Singleton: Garantizar una única instancia global y cuándo EVITARLO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Singleton: Garantizar una única instancia global y cuándo EVITARLO.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Singleton: Garantizar una única instancia global y cuándo EVITARLO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Patrón Factory Method: Delegar la instanciación a subclases especializadas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Factory Method: Delegar la instanciación a subclases especializadas.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Factory Method: Delegar la instanciación a subclases especializadas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Patrón Abstract Factory: Familias de objetos relacionados.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Abstract Factory: Familias de objetos relacionados.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Abstract Factory: Familias de objetos relacionados.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Patrón Builder: Construcción paso a paso de objetos complejos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Builder: Construcción paso a paso de objetos complejos.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Builder: Construcción paso a paso de objetos complejos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR).» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 2:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 3:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PATRONES DE DISEÑO CREACIONALES (GANG OF FOUR) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Composición de clases y objetos: Adapter, Decorator, Facade, Composite y Proxy. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR).",
      items: [
      ...
      content: "## 📘 Clase completa — PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nComposición de clases y objetos: Adapter, Decorator, Facade, Composite y Proxy. Los Patrones Estructurales explican cómo ensamblar objetos y clases en estructuras más grandes manteniendo la flexibilidad. El patrón **Adapter** actúa como un conversor de enchufe de viaje entre dos interfaces incompatibles. El patrón **Decorator** envuelve un objeto para agregar responsabilidades dinámicamente sin usar herencia rígida. El patrón **Facade** ofrece un único punto de entrada sencillo para ocultar la complejidad de un subsistema con decenas de clases.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Patrón Adapter: Adaptar interfaces incompatibles sin tocar el código fuente.\n· Patrón Decorator: Añadir funcionalidades a un objeto dinámicamente en tiempo de ejecución.\n· Patrón Facade (Fachada): Proporcionar una interfaz simplificada a un sistema complejo.\n· Patrón Composite: Tratar objetos individuales y composiciones de objetos de forma uniforme.\n· Patrón Proxy: Controlar el acceso a un objeto (Lazy loading, seguridad, almacenamiento en caché).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Patrón Adapter: Adaptar interfaces incompatibles sin tocar el código fuente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Adapter: Adaptar interfaces incompatibles sin tocar el código fuente.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Adapter: Adaptar interfaces incompatibles sin tocar el código fuente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Patrón Decorator: Añadir funcionalidades a un objeto dinámicamente en tiempo de ejecución.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Decorator: Añadir funcionalidades a un objeto dinámicamente en tiempo de ejecución.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Decorator: Añadir funcionalidades a un objeto dinámicamente en tiempo de ejecución.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Patrón Facade (Fachada): Proporcionar una interfaz simplificada a un sistema complejo.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Facade (Fachada): Proporcionar una interfaz simplificada a un sistema complejo.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Facade (Fachada): Proporcionar una interfaz simplificada a un sistema complejo.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Patrón Composite: Tratar objetos individuales y composiciones de objetos de forma uniforme.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Composite: Tratar objetos individuales y composiciones de objetos de forma uniforme.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Composite: Tratar objetos individuales y composiciones de objetos de forma uniforme.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Patrón Proxy: Controlar el acceso a un objeto (Lazy loading, seguridad, almacenamiento en caché).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Proxy: Controlar el acceso a un objeto (Lazy loading, seguridad, almacenamiento en caché).» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Proxy: Controlar el acceso a un objeto (Lazy loading, seguridad, almacenamiento en caché).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR).» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Refactors SOLID reducen incidentes y aceleran onboarding en equipos grandes.\n\n**Caso 2:** Refactors SOLID reducen incidentes y aceleran onboarding en equipos grandes.\n\n**Caso 3:** Refactors SOLID reducen incidentes y aceleran onboarding en equipos grandes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PATRONES DE DISEÑO ESTRUCTURALES (GANG OF FOUR) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Interacción y distribución de responsabilidades: Strategy, Observer, Command, State y Chain of Responsibility. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR).",
      items: [
      ...
      content: "## 📘 Clase completa — PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nInteracción y distribución de responsabilidades: Strategy, Observer, Command, State y Chain of Responsibility. Los Patrones de Comportamiento gestionan los algoritmos y la asignación de responsabilidades entre objetos. El patrón **Strategy** permite seleccionar un algoritmo en tiempo de ejecución de forma intercambiable (aplicando el OCP). El patrón **Observer** establece una relación uno-a-muchos donde un objeto notifica automáticamente a sus suscriptores cuando su estado cambia (base de la arquitectura orientada a eventos). El patrón **Command** convierte solicitudes en objetos para respaldar operaciones de deshacer (Undo).\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Patrón Strategy: Encapsular algoritmos intercambiables en tiempo de ejecución.\n· Patrón Observer: Suscripción y notificación de eventos 1 a N.\n· Patrón Command: Encapsular una petición como un objeto (Undo / Redo).\n· Patrón State: Permitir a un objeto alterar su comportamiento cuando su estado interno cambia.\n· Patrón Chain of Responsibility: Cadena de manejadores de peticiones independientes.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Patrón Strategy: Encapsular algoritmos intercambiables en tiempo de ejecución.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Strategy: Encapsular algoritmos intercambiables en tiempo de ejecución.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Strategy: Encapsular algoritmos intercambiables en tiempo de ejecución.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Patrón Observer: Suscripción y notificación de eventos 1 a N.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Observer: Suscripción y notificación de eventos 1 a N.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Observer: Suscripción y notificación de eventos 1 a N.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Patrón Command: Encapsular una petición como un objeto (Undo / Redo).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Command: Encapsular una petición como un objeto (Undo / Redo).» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Command: Encapsular una petición como un objeto (Undo / Redo).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Patrón State: Permitir a un objeto alterar su comportamiento cuando su estado interno cambia.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón State: Permitir a un objeto alterar su comportamiento cuando su estado interno cambia.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón State: Permitir a un objeto alterar su comportamiento cuando su estado interno cambia.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Patrón Chain of Responsibility: Cadena de manejadores de peticiones independientes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Patrón Chain of Responsibility: Cadena de manejadores de peticiones independientes.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Patrón Chain of Responsibility: Cadena de manejadores de peticiones independientes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR).» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) dentro de código mantenible, SOLID y patrones de diseño profesional.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 2:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\n**Caso 3:** Code reviews en Big Tech penalizan nombres crípticos y funciones de 200 líneas.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PATRONES DE DISEÑO DE COMPORTAMIENTO (GANG OF FOUR) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
