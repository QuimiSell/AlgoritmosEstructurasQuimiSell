...
export const KALI_LINUX_COURSE: Course = {
  ...
  modules: [{
      ...
      description: "Estructura del Filesystem Hierarchy Standard (FHS), redirecciones de flujos estándar, tuberías avanzadas y gestión estricta de permisos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO.",
      items: [
      ...
      content: "## 📘 Clase completa — KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstructura del Filesystem Hierarchy Standard (FHS), redirecciones de flujos estándar, tuberías avanzadas y gestión estricta de permisos. Kali Linux está basado en Debian Testing y optimizado para análisis de seguridad y pruebas de penetración. Comprender su arquitectura comienza por el conocimiento profundo del árbol de directorios FHS: el directorio /proc no contiene archivos reales en disco, sino una interfaz en memoria al kernel que expone el estado de los procesos y parámetros de red en vivo; /var/log almacena la bitácora histórica de eventos; y /usr/share alberga colecciones indispensables como diccionarios (/usr/share/wordlists) y scripts de Nmap (/usr/share/nmap/scripts). Dominar los flujos estándar (stdin 0, stdout 1, stderr 2) permite redirigir errores a /dev/null mientras se filtran salidas críticas con herramientas de procesamiento de texto como awk y sed.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· El estándar FHS (/etc, /var/log, /proc, /sys, /usr/share/wordlists).\n· Redirección de descriptores de archivo (stdin: 0, stdout: 1, stderr: 2, 2>&1).\n· Encadenamiento de comandos y tuberías (pipes |, ;, &&, ||).\n· Manipulación de texto con grep (regex), awk, sed y cut.\n· Sistema de permisos Linux: representación octal, umask y atributos especiales.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — El estándar FHS (/etc, /var/log, /proc, /sys, /usr/share/wordlists).\n\nTiempo sugerido al grabar: **7–9 minutos**. «El estándar FHS (/etc, /var/log, /proc, /sys, /usr/share/wordlists).» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El estándar FHS (/etc, /var/log, /proc, /sys, /usr/share/wordlists).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Redirección de descriptores de archivo (stdin: 0, stdout: 1, stderr: 2, 2>&1).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Redirección de descriptores de archivo (stdin: 0, stdout: 1, stderr: 2, 2>&1).» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Redirección de descriptores de archivo (stdin: 0, stdout: 1, stderr: 2, 2>&1).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Encadenamiento de comandos y tuberías (pipes |, ;, &&, ||).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Encadenamiento de comandos y tuberías (pipes |, ;, &&, ||).» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Encadenamiento de comandos y tuberías (pipes |, ;, &&, ||).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Manipulación de texto con grep (regex), awk, sed y cut.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Manipulación de texto con grep (regex), awk, sed y cut.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Manipulación de texto con grep (regex), awk, sed y cut.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Sistema de permisos Linux: representación octal, umask y atributos especiales.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Sistema de permisos Linux: representación octal, umask y atributos especiales.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Sistema de permisos Linux: representación octal, umask y atributos especiales.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar KERNEL LINUX, ARQUITECTURA DE KALI Y ENTORNO BASH AVANZADO es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Administración de servicios con systemctl, análisis forense de procesos en ejecución (ps, top, lsof) y manejo de señales del sistema operativo. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD.",
      items: [
      ...
      content: "## 📘 Clase completa — GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nAdministración de servicios con systemctl, análisis forense de procesos en ejecución (ps, top, lsof) y manejo de señales del sistema operativo. En Kali Linux, muchas herramientas operan como servicios en segundo plano (demonios), como PostgreSQL para la base de datos de Metasploit, el servidor OpenSSH o Apache2. La gestión moderna de servicios se realiza a través de systemd (\\\\`systemctl\\\\`). Para auditar el consumo y comportamiento de procesos, \\\\`ps aux\\\\` muestra el usuario ejecutor, el Process ID (PID), el porcentaje de CPU/Memoria y el comando exacto invocado. Cuando un proceso deja de responder o presenta anomalías, el administrador o auditor utiliza señales POSIX: \\\\`kill -15\\\\` (SIGTERM) solicita una terminación limpia permitiendo liberar recursos, mientras que \\\\`kill -9\\\\` (SIGKILL) fuerza la eliminación inmediata por parte del kernel sin posibilidad de captura.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Control de servicios y demonios de red (systemctl start, stop, enable, status).\n· Inspección de procesos y árboles de ejecución (ps aux, pstree, htop).\n· Señales POSIX fundamentales: SIGTERM (15), SIGKILL (9), SIGHUP (1) y SIGINT (2).\n· Inspección de archivos y sockets abiertos por procesos mediante lsof y fuser.\n· Monitoreo de logs centralizados del sistema mediante journalctl.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Control de servicios y demonios de red (systemctl start, stop, enable, status).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Control de servicios y demonios de red (systemctl start, stop, enable, status).» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Control de servicios y demonios de red (systemctl start, stop, enable, status).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Inspección de procesos y árboles de ejecución (ps aux, pstree, htop).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección de procesos y árboles de ejecución (ps aux, pstree, htop).» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección de procesos y árboles de ejecución (ps aux, pstree, htop).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Señales POSIX fundamentales: SIGTERM (15), SIGKILL (9), SIGHUP (1) y SIGINT (2).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Señales POSIX fundamentales: SIGTERM (15), SIGKILL (9), SIGHUP (1) y SIGINT (2).» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Señales POSIX fundamentales: SIGTERM (15), SIGKILL (9), SIGHUP (1) y SIGINT (2).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Inspección de archivos y sockets abiertos por procesos mediante lsof y fuser.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección de archivos y sockets abiertos por procesos mediante lsof y fuser.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección de archivos y sockets abiertos por procesos mediante lsof y fuser.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Monitoreo de logs centralizados del sistema mediante journalctl.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Monitoreo de logs centralizados del sistema mediante journalctl.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Monitoreo de logs centralizados del sistema mediante journalctl.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar GESTIÓN DE PROCESOS, SEÑALES POSIX Y DEMONIOS SYSTEMD es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Análisis del modelo TCP/IP, subredes CIDR, diagnóstico de sockets con 'ss', gestión de interfaces de red con 'ip' y resolución ARP. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO.",
      items: [
      ...
      content: "## 📘 Clase completa — ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nAnálisis del modelo TCP/IP, subredes CIDR, diagnóstico de sockets con 'ss', gestión de interfaces de red con 'ip' y resolución ARP. Comprender la pila de protocolos TCP/IP es imperativo para cualquier profesional de seguridad. En la capa de enlace de datos (capa 2), las tramas utilizan direcciones MAC físicas; en la capa de red (capa 3), los datagramas IP manejan direccionamiento lógico y enrutamiento; y en la capa de transporte (capa 4), TCP y UDP asignan puertos de comunicación. En las versiones actuales de Kali Linux, las herramientas tradicionales de net-tools (ifconfig, netstat, route) han sido sustituidas por la suite \\\\`iproute2\\\\` (\\\\`ip addr\\\\`, \\\\`ip route\\\\`, \\\\`ss\\\\`). El comando \\\\`ss -tulpn\\\\` inspecciona los sockets abiertos en modo escucha (TCP y UDP), mostrando el PID exacto y la dirección de enlace.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Capas del modelo TCP/IP vs OSI y encapsulación de tramas/paquetes/segmentos.\n· Comandos modernos de red: ip addr, ip route, ip link (reemplazo de ifconfig/route).\n· Inspección avanzada de sockets con 'ss -tulpn' y filtrado de estados TCP.\n· Mecanismo de resolución de direcciones de capa 2 (ARP) y tabla de vecinos con 'ip neigh'.\n· Diagnóstico de conectividad, MTU, latencia y saltos con ping, traceroute y mtr.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Capas del modelo TCP/IP vs OSI y encapsulación de tramas/paquetes/segmentos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Capas del modelo TCP/IP vs OSI y encapsulación de tramas/paquetes/segmentos.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Capas del modelo TCP/IP vs OSI y encapsulación de tramas/paquetes/segmentos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Comandos modernos de red: ip addr, ip route, ip link (reemplazo de ifconfig/route).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Comandos modernos de red: ip addr, ip route, ip link (reemplazo de ifconfig/route).» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Comandos modernos de red: ip addr, ip route, ip link (reemplazo de ifconfig/route).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Inspección avanzada de sockets con 'ss -tulpn' y filtrado de estados TCP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección avanzada de sockets con 'ss -tulpn' y filtrado de estados TCP.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección avanzada de sockets con 'ss -tulpn' y filtrado de estados TCP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Mecanismo de resolución de direcciones de capa 2 (ARP) y tabla de vecinos con 'ip neigh'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mecanismo de resolución de direcciones de capa 2 (ARP) y tabla de vecinos con 'ip neigh'.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mecanismo de resolución de direcciones de capa 2 (ARP) y tabla de vecinos con 'ip neigh'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Diagnóstico de conectividad, MTU, latencia y saltos con ping, traceroute y mtr.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diagnóstico de conectividad, MTU, latencia y saltos con ping, traceroute y mtr.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diagnóstico de conectividad, MTU, latencia y saltos con ping, traceroute y mtr.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ARQUITECTURA DE REDES TCP/IP, INTERFACES Y DIAGNÓSTICO DE ENRUTAMIENTO es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Técnicas de Ping Sweep, diferencias críticas entre sondas ARP e ICMP, resolución DNS inversa y optimización de latencia en auditorías. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL.",
      items: [
      ...
      content: "## 📘 Clase completa — NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nTécnicas de Ping Sweep, diferencias críticas entre sondas ARP e ICMP, resolución DNS inversa y optimización de latencia en auditorías. Nmap (Network Mapper) es el estándar internacional para el mapeo y auditoría de redes. La primera fase de cualquier evaluación de infraestructura consiste en el descubrimiento de hosts vivos (Host Discovery). Al ejecutar un barrido \\\\`nmap -sn\\\\` en un segmento Ethernet local como usuario con privilegios de root, Nmap ignora los paquetes ICMP tradicionales y envía directamente solicitudes ARP Request: esto se debe a que ningún firewall basado en host en una red local puede bloquear una petición ARP sin perder conectividad física. Por el contrario, en redes enrutadas (remotas), Nmap combina ICMP Echo Request, ICMP Timestamp, TCP SYN al puerto 443 y TCP ACK al puerto 80. Para maximizar la velocidad, la bandera \\\\`-n\\\\` desactiva las consultas DNS inversas.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Fundamentos de Nmap y fases de una auditoría de red.\n· Descubrimiento de hosts activos mediante Ping Sweep (nmap -sn).\n· Comportamiento de Nmap en red local (ARP Ping automático) vs redes remotas (ICMP + TCP).\n· Control de resolución DNS: sondas rápidas con deshabilitación de DNS (-n) vs forzado (-R).\n· Exportación de resultados a múltiples formatos: normal (-oN), grepable (-oG) y XML (-oX).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Fundamentos de Nmap y fases de una auditoría de red.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fundamentos de Nmap y fases de una auditoría de red.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fundamentos de Nmap y fases de una auditoría de red.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Descubrimiento de hosts activos mediante Ping Sweep (nmap -sn).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Descubrimiento de hosts activos mediante Ping Sweep (nmap -sn).» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Descubrimiento de hosts activos mediante Ping Sweep (nmap -sn).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Comportamiento de Nmap en red local (ARP Ping automático) vs redes remotas (ICMP + TCP).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Comportamiento de Nmap en red local (ARP Ping automático) vs redes remotas (ICMP + TCP).» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Comportamiento de Nmap en red local (ARP Ping automático) vs redes remotas (ICMP + TCP).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Control de resolución DNS: sondas rápidas con deshabilitación de DNS (-n) vs forzado (-R).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Control de resolución DNS: sondas rápidas con deshabilitación de DNS (-n) vs forzado (-R).» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Control de resolución DNS: sondas rápidas con deshabilitación de DNS (-n) vs forzado (-R).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Exportación de resultados a múltiples formatos: normal (-oN), grepable (-oG) y XML (-oX).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Exportación de resultados a múltiples formatos: normal (-oN), grepable (-oG) y XML (-oX).» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Exportación de resultados a múltiples formatos: normal (-oN), grepable (-oG) y XML (-oX).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar NMAP BÁSICO: DESCUBRIMIENTO DE HOSTS Y SONDEO DE RED LOCAL es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Estudio detallado del 3-Way Handshake, TCP SYN Stealth Scan (-sS), TCP Connect Scan (-sT), UDP Scan (-sU) y escaneos de banderas RFC 793 (FIN, Xmas, NULL). Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP.",
      items: [
      ...
      content: "## 📘 Clase completa — NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstudio detallado del 3-Way Handshake, TCP SYN Stealth Scan (-sS), TCP Connect Scan (-sT), UDP Scan (-sU) y escaneos de banderas RFC 793 (FIN, Xmas, NULL). Para entender la diferencia entre las modalidades de escaneo de puertos de Nmap, se debe analizar el intercambio de paquetes a nivel de socket. El escaneo por defecto de Nmap (cuando se ejecuta con privilegios de root) es el **TCP SYN Scan (\\\\`-sS\\\\`)**, denominado también escaneo 'semiabierto' o 'sigiloso': Nmap envía un paquete con la bandera SYN. Si el puerto está **abierto**, el objetivo responde con SYN-ACK; en ese instante, Nmap responde con un paquete RST (Reset) para derribar la conexión inmediatamente antes de que se complete el handshake de tres vías. Esto evita que la aplicación de nivel superior (como Apache o Nginx) registre una conexión establecida. Por el contrario, el **TCP Connect Scan (\\\\`-sT\\\\`)** invoca la llamada al sistema estándar \\\\`connect()\\\\`, completando el handshake entero y dejando un rastro evidente en los logs del servidor.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· El saludo de tres vías (SYN, SYN-ACK, ACK) y la respuesta RST (Reset).\n· Mecanismo interno del TCP SYN Stealth Scan (-sS) y por qué requiere permisos de superusuario.\n· TCP Connect Scan (-sT): funcionamiento en espacio de usuario y huella en logs de aplicación.\n· Dificultades y comportamiento de los escaneos UDP (-sU): ICMP Port Unreachable tipo 3 código 3.\n· Escaneos de banderas avanzadas RFC 793: NULL (-sN), FIN (-sF) y Xmas (-sX).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — El saludo de tres vías (SYN, SYN-ACK, ACK) y la respuesta RST (Reset).\n\nTiempo sugerido al grabar: **7–9 minutos**. «El saludo de tres vías (SYN, SYN-ACK, ACK) y la respuesta RST (Reset).» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El saludo de tres vías (SYN, SYN-ACK, ACK) y la respuesta RST (Reset).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Mecanismo interno del TCP SYN Stealth Scan (-sS) y por qué requiere permisos de superusuario.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mecanismo interno del TCP SYN Stealth Scan (-sS) y por qué requiere permisos de superusuario.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mecanismo interno del TCP SYN Stealth Scan (-sS) y por qué requiere permisos de superusuario.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — TCP Connect Scan (-sT): funcionamiento en espacio de usuario y huella en logs de aplicación.\n\nTiempo sugerido al grabar: **7–9 minutos**. «TCP Connect Scan (-sT): funcionamiento en espacio de usuario y huella en logs de aplicación.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «TCP Connect Scan (-sT): funcionamiento en espacio de usuario y huella en logs de aplicación.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Dificultades y comportamiento de los escaneos UDP (-sU): ICMP Port Unreachable tipo 3 código 3.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Dificultades y comportamiento de los escaneos UDP (-sU): ICMP Port Unreachable tipo 3 código 3.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Dificultades y comportamiento de los escaneos UDP (-sU): ICMP Port Unreachable tipo 3 código 3.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Escaneos de banderas avanzadas RFC 793: NULL (-sN), FIN (-sF) y Xmas (-sX).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Escaneos de banderas avanzadas RFC 793: NULL (-sN), FIN (-sF) y Xmas (-sX).» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Escaneos de banderas avanzadas RFC 793: NULL (-sN), FIN (-sF) y Xmas (-sX).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar NMAP AVANZADO I: TÉCNICAS DE ESCANEO DE PUERTOS Y ANÁLISIS DE PAQUETES TCP es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Plantillas de temporización (-T0 a -T5), fragmentación de paquetes MTU (-f), señuelos aleatorios (-D), falsificación de origen y evasión de firmas. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS.",
      items: [
      ...
      content: "## 📘 Clase completa — NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nPlantillas de temporización (-T0 a -T5), fragmentación de paquetes MTU (-f), señuelos aleatorios (-D), falsificación de origen y evasión de firmas. Los Sistemas de Detección de Intrusos (IDS) y Firewalls modernos analizan patrones de tráfico para detectar y bloquear escaneos de red. Nmap proporciona mecanismos avanzados de temporización y evasión. Las plantillas de tiempo controlan el paralelismo y los tiempos de espera: **-T0 (Paranoid)** introduce pausas de hasta 5 minutos entre sondas para evadir umbrales de detección basados en frecuencia; mientras que **-T4 (Aggressive)** acelera el proceso para redes modernas y estables. Para ofuscar el origen, la opción de señuelos **\\\\`-D\\\\` (Decoys)** mezcla la dirección IP real del auditor con direcciones IP falsas, provocando que los logs del IDS del objetivo registren múltiples orígenes simultáneos y dificulten identificar al atacante real.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Las 6 plantillas de temporización de Nmap (-T0 Paranoid, -T1 Sneaky, -T2 Polite, -T3 Normal, -T4 Aggressive, -T5 Insane).\n· Fragmentación de paquetes TCP/IP mediante -f y --mtu para evadir inspección de paquetes simples.\n· Uso de señuelos (Decoys -D) con IPs falsas y aleatorias (RND) para ofuscar el origen real.\n· Falsificación de puerto de origen (--source-port / -g 53) para burlar reglas de firewall mal configuradas.\n· Modificación del tamaño de datos arbitrarios (--data-length) y MAC spoofing (--spoof-mac).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Las 6 plantillas de temporización de Nmap (-T0 Paranoid, -T1 Sneaky, -T2 Polite, -T3 Normal, -T4 Aggressive, -T5 Insane).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Las 6 plantillas de temporización de Nmap (-T0 Paranoid, -T1 Sneaky, -T2 Polite, -T3 Normal, -T4 Aggressive, -T5 Insane).» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Las 6 plantillas de temporización de Nmap (-T0 Paranoid, -T1 Sneaky, -T2 Polite, -T3 Normal, -T4 Aggressive, -T5 Insane).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Fragmentación de paquetes TCP/IP mediante -f y --mtu para evadir inspección de paquetes simples.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fragmentación de paquetes TCP/IP mediante -f y --mtu para evadir inspección de paquetes simples.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fragmentación de paquetes TCP/IP mediante -f y --mtu para evadir inspección de paquetes simples.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Uso de señuelos (Decoys -D) con IPs falsas y aleatorias (RND) para ofuscar el origen real.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Uso de señuelos (Decoys -D) con IPs falsas y aleatorias (RND) para ofuscar el origen real.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Uso de señuelos (Decoys -D) con IPs falsas y aleatorias (RND) para ofuscar el origen real.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Falsificación de puerto de origen (--source-port / -g 53) para burlar reglas de firewall mal configuradas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Falsificación de puerto de origen (--source-port / -g 53) para burlar reglas de firewall mal configuradas.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Falsificación de puerto de origen (--source-port / -g 53) para burlar reglas de firewall mal configuradas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Modificación del tamaño de datos arbitrarios (--data-length) y MAC spoofing (--spoof-mac).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Modificación del tamaño de datos arbitrarios (--data-length) y MAC spoofing (--spoof-mac).» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Modificación del tamaño de datos arbitrarios (--data-length) y MAC spoofing (--spoof-mac).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar NMAP AVANZADO II: EVASIÓN DE IDS/FIREWALLS, TEMPORIZACIÓN Y SEÑUELOS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Estructura del motor NSE escrito en Lua, categorías de scripts (safe, vuln, auth, discovery, default), paso de argumentos y detección de CVEs. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES.",
      items: [
      ...
      content: "## 📘 Clase completa — NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstructura del motor NSE escrito en Lua, categorías de scripts (safe, vuln, auth, discovery, default), paso de argumentos y detección de CVEs. El **Nmap Scripting Engine (NSE)** es una de las características más potentes de Nmap, permitiendo automatizar una amplia variedad de tareas de red mediante scripts escritos en el lenguaje Lua. Los scripts están organizados por categorías según su nivel de intrusión: **\\\\`safe\\\\`** (scripts que no alteran el servicio ni causan caídas), **\\\\`vuln\\\\`** (scripts que verifican la presencia de vulnerabilidades conocidas y CVEs), **\\\\`auth\\\\`** (evaluación de mecanismos de autenticación) y **\\\\`default\\\\`** (ejecutados automáticamente al usar \\\\`-sC\\\\`). Utilizar el motor NSE de forma controlada permite auditar configuraciones débiles de TLS/SSL, recursos SMB compartidos sin autenticación o versiones vulnerables de servidores web sin recurrir a exploits destructivos.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Arquitectura del Nmap Scripting Engine (NSE) ubicado en /usr/share/nmap/scripts/.\n· Categorías de scripts de Nmap: default, safe, intrusive, vuln, auth, discovery, malware.\n· Ejecución selectiva de scripts con expresiones lógicas (--script 'vuln and safe').\n· Paso de credenciales y parámetros de configuración mediante --script-args.\n· Actualización de la base de datos de scripts con 'nmap --script-updatedb'.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Arquitectura del Nmap Scripting Engine (NSE) ubicado en /usr/share/nmap/scripts/.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Arquitectura del Nmap Scripting Engine (NSE) ubicado en /usr/share/nmap/scripts/.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Arquitectura del Nmap Scripting Engine (NSE) ubicado en /usr/share/nmap/scripts/.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Categorías de scripts de Nmap: default, safe, intrusive, vuln, auth, discovery, malware.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Categorías de scripts de Nmap: default, safe, intrusive, vuln, auth, discovery, malware.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Categorías de scripts de Nmap: default, safe, intrusive, vuln, auth, discovery, malware.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Ejecución selectiva de scripts con expresiones lógicas (--script 'vuln and safe').\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ejecución selectiva de scripts con expresiones lógicas (--script 'vuln and safe').» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ejecución selectiva de scripts con expresiones lógicas (--script 'vuln and safe').» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Paso de credenciales y parámetros de configuración mediante --script-args.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Paso de credenciales y parámetros de configuración mediante --script-args.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Paso de credenciales y parámetros de configuración mediante --script-args.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Actualización de la base de datos de scripts con 'nmap --script-updatedb'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Actualización de la base de datos de scripts con 'nmap --script-updatedb'.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Actualización de la base de datos de scripts con 'nmap --script-updatedb'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar NMAP SCRIPTING ENGINE (NSE): AUTOMATIZACIÓN Y DETECCIÓN DE VULNERABILIDADES es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Recolección de información sin interacción directa con el objetivo: registros DNS (A, MX, TXT, NS), transferencia de zona AXFR, WHOIS y análisis de metadatos con ExifTool. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS).",
      items: [
      ...
      content: "## 📘 Clase completa — RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nRecolección de información sin interacción directa con el objetivo: registros DNS (A, MX, TXT, NS), transferencia de zona AXFR, WHOIS y análisis de metadatos con ExifTool. El reconocimiento pasivo (Open Source Intelligence - OSINT) consiste en recolectar información pública sobre una organización sin enviar paquetes directos a sus servidores perimetrales, minimizando el riesgo de ser detectado o alertar a los equipos de defensa. Las consultas al Sistema de Nombres de Dominio (DNS) son fundamentales: herramientas como \\\\`dig\\\\` permiten interrogar registros MX (servidores de correo), registros TXT (donde residen políticas SPF y registros de verificación) y servidores de nombres (NS). Una falla crítica de configuración en servidores DNS es la **Transferencia de Zona DNS (AXFR)** no restringida: si un servidor DNS autoritativo permite AXFR a cualquier IP pública, un atacante o auditor puede descargar en segundos el mapa completo de todos los subdominios y registros internos de la organización.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Diferencia operativa entre reconocimiento pasivo (sin tocar el objetivo) y activo.\n· Consultas DNS avanzadas con dig y host: registros SOA, MX, TXT (SPF/DMARC) y NS.\n· Transferencia de zona DNS completa (AXFR con dig axfr @nameserver) y sus riesgos.\n· Recolección automatizada de correos y subdominios con theHarvester.\n· Extracción y eliminación forense de metadatos en documentos mediante exiftool.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Diferencia operativa entre reconocimiento pasivo (sin tocar el objetivo) y activo.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diferencia operativa entre reconocimiento pasivo (sin tocar el objetivo) y activo.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diferencia operativa entre reconocimiento pasivo (sin tocar el objetivo) y activo.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Consultas DNS avanzadas con dig y host: registros SOA, MX, TXT (SPF/DMARC) y NS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Consultas DNS avanzadas con dig y host: registros SOA, MX, TXT (SPF/DMARC) y NS.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Consultas DNS avanzadas con dig y host: registros SOA, MX, TXT (SPF/DMARC) y NS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Transferencia de zona DNS completa (AXFR con dig axfr @nameserver) y sus riesgos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Transferencia de zona DNS completa (AXFR con dig axfr @nameserver) y sus riesgos.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Transferencia de zona DNS completa (AXFR con dig axfr @nameserver) y sus riesgos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Recolección automatizada de correos y subdominios con theHarvester.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Recolección automatizada de correos y subdominios con theHarvester.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Recolección automatizada de correos y subdominios con theHarvester.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Extracción y eliminación forense de metadatos en documentos mediante exiftool.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Extracción y eliminación forense de metadatos en documentos mediante exiftool.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Extracción y eliminación forense de metadatos en documentos mediante exiftool.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS).» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar RECONOCIMIENTO PASIVO Y OSINT (DNS, WHOIS, THEHARVESTER Y METADATOS) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Captura de paquetes en terminal con Tcpdump, sintaxis de filtros Berkeley Packet Filters (BPF), análisis automatizado con Tshark y disección de archivos PCAP. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF).",
      items: [
      ...
      content: "## 📘 Clase completa — ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nCaptura de paquetes en terminal con Tcpdump, sintaxis de filtros Berkeley Packet Filters (BPF), análisis automatizado con Tshark y disección de archivos PCAP. La inspección de tráfico de red a bajo nivel es una habilidad indispensable tanto para analistas de seguridad defensiva (SOC/Blue Team) como para evaluadores de seguridad. Mientras que Wireshark ofrece una interfaz gráfica, en servidores o entornos remotos Kali Linux se apoya en **\\\\`tcpdump\\\\`** y **\\\\`tshark\\\\`**. Tcpdump utiliza **filtros BPF (Berkeley Packet Filters)** aplicados en el kernel para descartar el tráfico irrelevante antes de que llegue al espacio de usuario, optimizando el rendimiento. Un filtro BPF como \\\\`'tcp and port 80 and (tcp[tcpflags] & tcp-syn != 0)'\\\\` permite capturar con precisión quirúrgica únicamente los paquetes de inicio de conexión HTTP.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Fundamentos de la captura de tramas y modo promiscuo en interfaces de red.\n· Uso de tcpdump: captura en vivo, escritura (-w) y lectura (-r) de archivos PCAP.\n· Sintaxis de filtros BPF (Berkeley Packet Filters): hosts, puertos, protocolos y operadores lógicos.\n· Análisis no interactivo y extracción de campos de protocolo con tshark (-T fields -e).\n· Inspección de anomalías en flujos HTTP y solicitudes DNS sin cifrar.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Fundamentos de la captura de tramas y modo promiscuo en interfaces de red.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fundamentos de la captura de tramas y modo promiscuo en interfaces de red.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fundamentos de la captura de tramas y modo promiscuo en interfaces de red.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Uso de tcpdump: captura en vivo, escritura (-w) y lectura (-r) de archivos PCAP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Uso de tcpdump: captura en vivo, escritura (-w) y lectura (-r) de archivos PCAP.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Uso de tcpdump: captura en vivo, escritura (-w) y lectura (-r) de archivos PCAP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Sintaxis de filtros BPF (Berkeley Packet Filters): hosts, puertos, protocolos y operadores lógicos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Sintaxis de filtros BPF (Berkeley Packet Filters): hosts, puertos, protocolos y operadores lógicos.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Sintaxis de filtros BPF (Berkeley Packet Filters): hosts, puertos, protocolos y operadores lógicos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Análisis no interactivo y extracción de campos de protocolo con tshark (-T fields -e).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Análisis no interactivo y extracción de campos de protocolo con tshark (-T fields -e).» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Análisis no interactivo y extracción de campos de protocolo con tshark (-T fields -e).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Inspección de anomalías en flujos HTTP y solicitudes DNS sin cifrar.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección de anomalías en flujos HTTP y solicitudes DNS sin cifrar.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección de anomalías en flujos HTTP y solicitudes DNS sin cifrar.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF).» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ANÁLISIS E INSPECCIÓN DE TRÁFICO (WIRESHARK, TSHARK Y TCPDUMP CON FILTROS BPF) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Descubrimiento de endpoints ocultos y recursos no indexados mediante Gobuster, FFuF, análisis de códigos de respuesta HTTP y wordlists especializadas. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING.",
      items: [
      ...
      content: "## 📘 Clase completa — AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nDescubrimiento de endpoints ocultos y recursos no indexados mediante Gobuster, FFuF, análisis de códigos de respuesta HTTP y wordlists especializadas. Las aplicaciones web a menudo contienen rutas, paneles de administración, respaldos o archivos de configuración que no están enlazados en el menú principal ni indexados por motores de búsqueda. La enumeración de contenido web o **fuzzing de directorios** consiste en enviar miles de peticiones HTTP probando nombres comunes a partir de diccionarios (**wordlists**). Herramientas como **Gobuster** (escrita en Go para alta concurrencia) y **FFuF** envían peticiones paralelas y analizan el código de respuesta HTTP devuelto por el servidor: un código \\\\`200\\\\` confirma la existencia del recurso, \\\\`301/302\\\\` indica redirección, \\\\`403\\\\` revela que el recurso existe pero tiene acceso restringido, y \\\\`404\\\\` señala que no fue encontrado.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· El principio de fuzzing web y fuerza bruta sobre rutas y endpoints HTTP.\n· Uso de Gobuster (gobuster dir) para enumeración recursiva y concurrente.\n· Fuzzing avanzado de parámetros, cabeceras y rutas con FFuF (Fast Web Fuzzer).\n· Estructura de códigos de estado HTTP (200 OK, 301/302 Redirect, 401/403 Forbidden, 500 Error).\n· Ubicación y selección de wordlists en Kali Linux (/usr/share/wordlists/dirb, SecLists).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — El principio de fuzzing web y fuerza bruta sobre rutas y endpoints HTTP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El principio de fuzzing web y fuerza bruta sobre rutas y endpoints HTTP.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El principio de fuzzing web y fuerza bruta sobre rutas y endpoints HTTP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Uso de Gobuster (gobuster dir) para enumeración recursiva y concurrente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Uso de Gobuster (gobuster dir) para enumeración recursiva y concurrente.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Uso de Gobuster (gobuster dir) para enumeración recursiva y concurrente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Fuzzing avanzado de parámetros, cabeceras y rutas con FFuF (Fast Web Fuzzer).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fuzzing avanzado de parámetros, cabeceras y rutas con FFuF (Fast Web Fuzzer).» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fuzzing avanzado de parámetros, cabeceras y rutas con FFuF (Fast Web Fuzzer).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Estructura de códigos de estado HTTP (200 OK, 301/302 Redirect, 401/403 Forbidden, 500 Error).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Estructura de códigos de estado HTTP (200 OK, 301/302 Redirect, 401/403 Forbidden, 500 Error).» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Estructura de códigos de estado HTTP (200 OK, 301/302 Redirect, 401/403 Forbidden, 500 Error).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Ubicación y selección de wordlists en Kali Linux (/usr/share/wordlists/dirb, SecLists).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ubicación y selección de wordlists en Kali Linux (/usr/share/wordlists/dirb, SecLists).» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ubicación y selección de wordlists en Kali Linux (/usr/share/wordlists/dirb, SecLists).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar AUDITORÍA WEB I: ENUMERACIÓN DE DIRECTORIOS, SUBDOMINIOS Y FUZZING es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Escaneo automatizado de vulnerabilidades con Nikto, identificación de archivos peligrosos, diagnóstico de cabeceras de seguridad y principios del OWASP Top 10. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS).",
      items: [
      ...
      content: "## 📘 Clase completa — AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEscaneo automatizado de vulnerabilidades con Nikto, identificación de archivos peligrosos, diagnóstico de cabeceras de seguridad y principios del OWASP Top 10. La evaluación de la postura de seguridad de un servidor web requiere verificar no solo los puertos abiertos, sino las configuraciones de la aplicación y la presencia de vulnerabilidades conocidas. **Nikto** es un escáner Open Source especializado en servidores web que realiza pruebas contra más de 6,700 archivos potencialmente peligrosos, programas desactualizados y problemas de configuración específicos del servidor (como Apache, Nginx o IIS). Al mismo tiempo, una auditoría rigurosa evalúa las **cabeceras de seguridad HTTP**: la ausencia de \\\\`Strict-Transport-Security\\\\` (HSTS) permite ataques de degradación a HTTP sin cifrar; la falta de \\\\`X-Frame-Options\\\\` expone a la aplicación a Clickjacking; y las cookies sin la bandera \\\\`HttpOnly\\\\` son vulnerables a robo mediante Cross-Site Scripting (XSS).\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Escaneo de servidores web con Nikto: detección de software obsoleto y archivos sensibles.\n· Diagnóstico de cabeceras HTTP de seguridad (Content-Security-Policy, HSTS, X-Frame-Options).\n· Fundamentos del OWASP Top 10 (SQL Injection, XSS, Broken Access Control, Security Misconfiguration).\n· Identificación de atributos seguros en cookies de sesión (HttpOnly, Secure, SameSite).\n· Generación y exportación de reportes de auditoría web en formatos HTML/XML.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Escaneo de servidores web con Nikto: detección de software obsoleto y archivos sensibles.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Escaneo de servidores web con Nikto: detección de software obsoleto y archivos sensibles.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Escaneo de servidores web con Nikto: detección de software obsoleto y archivos sensibles.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Diagnóstico de cabeceras HTTP de seguridad (Content-Security-Policy, HSTS, X-Frame-Options).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diagnóstico de cabeceras HTTP de seguridad (Content-Security-Policy, HSTS, X-Frame-Options).» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diagnóstico de cabeceras HTTP de seguridad (Content-Security-Policy, HSTS, X-Frame-Options).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Fundamentos del OWASP Top 10 (SQL Injection, XSS, Broken Access Control, Security Misconfiguration).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fundamentos del OWASP Top 10 (SQL Injection, XSS, Broken Access Control, Security Misconfiguration).» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fundamentos del OWASP Top 10 (SQL Injection, XSS, Broken Access Control, Security Misconfiguration).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Identificación de atributos seguros en cookies de sesión (HttpOnly, Secure, SameSite).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Identificación de atributos seguros en cookies de sesión (HttpOnly, Secure, SameSite).» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Identificación de atributos seguros en cookies de sesión (HttpOnly, Secure, SameSite).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Generación y exportación de reportes de auditoría web en formatos HTML/XML.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Generación y exportación de reportes de auditoría web en formatos HTML/XML.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Generación y exportación de reportes de auditoría web en formatos HTML/XML.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS).» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar AUDITORÍA WEB II: ANÁLISIS DE VULNERABILIDADES (NIKTO, OWASP TOP 10 Y CABECERAS) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Modos de interfaz WiFi (Managed vs Monitor), captura de tramas de gestión con Airodump-ng, análisis del 4-Way Handshake WPA2/WPA3 y fundamentos EAPOL. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE).",
      items: [
      ...
      content: "## 📘 Clase completa — DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nModos de interfaz WiFi (Managed vs Monitor), captura de tramas de gestión con Airodump-ng, análisis del 4-Way Handshake WPA2/WPA3 y fundamentos EAPOL. Las redes inalámbricas transmiten tramas de radiofrecuencia a través del medio abierto. Para auditar una red 802.11, la tarjeta de red debe colocarse en **Modo Monitor (RFMON)**: a diferencia del modo cliente tradicional ('Managed'), el modo monitor permite a la tarjeta capturar todas las tramas que circulan por el canal de radio sin necesidad de estar asociada a un punto de acceso. La suite **Aircrack-ng** es el conjunto estándar de herramientas en Kali Linux. El proceso de auditoría de WPA2-PSK se basa en capturar el **4-Way Handshake EAPOL**: un intercambio de cuatro mensajes criptográficos que derivan la clave temporal de sesión (PTK) sin transmitir jamás la contraseña en texto claro. En WPA3, este protocolo fue reemplazado por SAE (Dragonfly handshake) para prevenir ataques de diccionario fuera de línea.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Arquitectura del estándar IEEE 802.11: canales de 2.4 GHz vs 5 GHz, SSIDs y BSSIDs.\n· Habilitación y gestión del modo Monitor mediante 'airmon-ng' y eliminación de procesos conflictivos.\n· Captura y filtrado de tramas inalámbricas (Beacon, Probe, Data) con airodump-ng.\n· El intercambio de 4 vías (4-Way Handshake EAPOL) en WPA2-PSK: ANonce, SNonce, MIC.\n· Diferencias de seguridad entre WPA2 (PSK) y WPA3 (SAE - Simultaneous Authentication of Equals).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Arquitectura del estándar IEEE 802.11: canales de 2.4 GHz vs 5 GHz, SSIDs y BSSIDs.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Arquitectura del estándar IEEE 802.11: canales de 2.4 GHz vs 5 GHz, SSIDs y BSSIDs.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Arquitectura del estándar IEEE 802.11: canales de 2.4 GHz vs 5 GHz, SSIDs y BSSIDs.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Habilitación y gestión del modo Monitor mediante 'airmon-ng' y eliminación de procesos conflictivos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Habilitación y gestión del modo Monitor mediante 'airmon-ng' y eliminación de procesos conflictivos.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Habilitación y gestión del modo Monitor mediante 'airmon-ng' y eliminación de procesos conflictivos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Captura y filtrado de tramas inalámbricas (Beacon, Probe, Data) con airodump-ng.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Captura y filtrado de tramas inalámbricas (Beacon, Probe, Data) con airodump-ng.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Captura y filtrado de tramas inalámbricas (Beacon, Probe, Data) con airodump-ng.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — El intercambio de 4 vías (4-Way Handshake EAPOL) en WPA2-PSK: ANonce, SNonce, MIC.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El intercambio de 4 vías (4-Way Handshake EAPOL) en WPA2-PSK: ANonce, SNonce, MIC.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El intercambio de 4 vías (4-Way Handshake EAPOL) en WPA2-PSK: ANonce, SNonce, MIC.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Diferencias de seguridad entre WPA2 (PSK) y WPA3 (SAE - Simultaneous Authentication of Equals).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Diferencias de seguridad entre WPA2 (PSK) y WPA3 (SAE - Simultaneous Authentication of Equals).» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Diferencias de seguridad entre WPA2 (PSK) y WPA3 (SAE - Simultaneous Authentication of Equals).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE).» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar DIAGNÓSTICO Y AUDITORÍA DE REDES INALÁMBRICAS 802.11 (AIRCRACK-NG SUITE) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Funciones hash unidireccionales (MD5, SHA-256, NTLM, bcrypt), identificación de algoritmos, ataques basados en diccionarios y reglas de mutación. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN).",
      items: [
      ...
      content: "## 📘 Clase completa — CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nFunciones hash unidireccionales (MD5, SHA-256, NTLM, bcrypt), identificación de algoritmos, ataques basados en diccionarios y reglas de mutación. Las funciones hash criptográficas son algoritmos matemáticos deterministas y unidireccionales: transforman una entrada de longitud arbitraria en un resumen de longitud fija (digest), siendo computacionalmente inviable revertir el proceso para obtener el texto original. En auditorías de seguridad, los analistas evalúan la fortaleza de las políticas de contraseñas mediante pruebas de recuperación de hashes. **John the Ripper** y **Hashcat** son las herramientas insignia para este propósito. Mientras que John destaca por su facilidad en entornos CPU y el parseo automático de formatos como \\\\`/etc/shadow\\\\`, Hashcat aprovecha el procesamiento masivamente paralelo de tarjetas gráficas (GPUs con OpenCL/CUDA), permitiendo evaluar millones de combinaciones por segundo contra hashes NTLM, SHA-256 o Kerberos.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Propiedades de las funciones hash criptográficas: unidireccionalidad y resistencia a colisiones.\n· Identificación de tipos de hash con hash-identifier y hashID.\n· Estructura del archivo de contraseñas de Linux (/etc/shadow) y algoritmos ($6$ SHA-512, $y$ yescrypt).\n· Auditoría de contraseñas con John the Ripper (john) y reglas de permutación (--rules).\n· Aceleración por GPU y modos de ataque con Hashcat (-m mode, -a attack_mode).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Propiedades de las funciones hash criptográficas: unidireccionalidad y resistencia a colisiones.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Propiedades de las funciones hash criptográficas: unidireccionalidad y resistencia a colisiones.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Propiedades de las funciones hash criptográficas: unidireccionalidad y resistencia a colisiones.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Identificación de tipos de hash con hash-identifier y hashID.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Identificación de tipos de hash con hash-identifier y hashID.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Identificación de tipos de hash con hash-identifier y hashID.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Estructura del archivo de contraseñas de Linux (/etc/shadow) y algoritmos ($6$ SHA-512, $y$ yescrypt).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Estructura del archivo de contraseñas de Linux (/etc/shadow) y algoritmos ($6$ SHA-512, $y$ yescrypt).» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Estructura del archivo de contraseñas de Linux (/etc/shadow) y algoritmos ($6$ SHA-512, $y$ yescrypt).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Auditoría de contraseñas con John the Ripper (john) y reglas de permutación (--rules).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Auditoría de contraseñas con John the Ripper (john) y reglas de permutación (--rules).» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Auditoría de contraseñas con John the Ripper (john) y reglas de permutación (--rules).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aceleración por GPU y modos de ataque con Hashcat (-m mode, -a attack_mode).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aceleración por GPU y modos de ataque con Hashcat (-m mode, -a attack_mode).» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aceleración por GPU y modos de ataque con Hashcat (-m mode, -a attack_mode).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN).» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar CRIPTOGRAFÍA PRÁCTICA, HASHING Y ANÁLISIS DE CREDENCIALES (HASHCAT & JOHN) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "La 'navaja suiza' de redes Netcat (nc), banner grabbing manual, transferencia de datos TCP/UDP, servidores web efímeros en Python y retransmisión con Socat. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT).",
      items: [
      ...
      content: "## 📘 Clase completa — TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nLa 'navaja suiza' de redes Netcat (nc), banner grabbing manual, transferencia de datos TCP/UDP, servidores web efímeros en Python y retransmisión con Socat. Conocida como la 'navaja suiza de TCP/IP', **Netcat (\\\\`nc\\\\`)** es una de las utilidades más versátiles en Linux para leer y escribir datos a través de conexiones de red utilizando los protocolos TCP o UDP. En auditorías de infraestructura, Netcat se emplea para **Banner Grabbing**: conectarse directamente al puerto de un servicio (como el puerto 21 de FTP o 25 de SMTP) e interactuar con él mediante comandos en texto claro para capturar el encabezado que revela el software y la versión exacta en ejecución. Asimismo, Netcat permite transferir archivos entre máquinas conectando la salida estándar (\\\\`stdout\\\\`) a un socket, y su sucesor avanzado, **Socat**, amplía estas capacidades permitiendo reenvío de puertos y encapsulación SSL/TLS bidireccional.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Fundamentos de Netcat (nc): modo cliente, modo escucha (-l), verbosidad (-v) y puertos numéricos (-n).\n· Banner Grabbing manual sobre servicios HTTP, FTP y SMTP para identificar versiones.\n· Transferencia de archivos y respaldos directos a través de tuberías y sockets de red.\n· Creación de servidores HTTP efímeros en Kali para entrega de herramientas (python3 -m http.server).\n· Retransmisión bidireccional y proxy de sockets con Socat (Socket Cat).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Fundamentos de Netcat (nc): modo cliente, modo escucha (-l), verbosidad (-v) y puertos numéricos (-n).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fundamentos de Netcat (nc): modo cliente, modo escucha (-l), verbosidad (-v) y puertos numéricos (-n).» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fundamentos de Netcat (nc): modo cliente, modo escucha (-l), verbosidad (-v) y puertos numéricos (-n).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Banner Grabbing manual sobre servicios HTTP, FTP y SMTP para identificar versiones.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Banner Grabbing manual sobre servicios HTTP, FTP y SMTP para identificar versiones.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Banner Grabbing manual sobre servicios HTTP, FTP y SMTP para identificar versiones.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Transferencia de archivos y respaldos directos a través de tuberías y sockets de red.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Transferencia de archivos y respaldos directos a través de tuberías y sockets de red.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Transferencia de archivos y respaldos directos a través de tuberías y sockets de red.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Creación de servidores HTTP efímeros en Kali para entrega de herramientas (python3 -m http.server).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Creación de servidores HTTP efímeros en Kali para entrega de herramientas (python3 -m http.server).» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Creación de servidores HTTP efímeros en Kali para entrega de herramientas (python3 -m http.server).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Retransmisión bidireccional y proxy de sockets con Socat (Socket Cat).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Retransmisión bidireccional y proxy de sockets con Socat (Socket Cat).» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Retransmisión bidireccional y proxy de sockets con Socat (Socket Cat).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT).» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar TRANSFERENCIA DE ARCHIVOS, SERVIDORES EFÍMEROS Y MANIPULACIÓN DE SOCKETS (NETCAT & SOCAT) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Técnicas de salto de red (Pivoting), reenvío de puertos local (ssh -L), reenvío remoto (ssh -R), túneles dinámicos SOCKS5 (ssh -D) y enrutamiento con Proxychains. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH.",
      items: [
      ...
      content: "## 📘 Clase completa — PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nTécnicas de salto de red (Pivoting), reenvío de puertos local (ssh -L), reenvío remoto (ssh -R), túneles dinámicos SOCKS5 (ssh -D) y enrutamiento con Proxychains. En infraestructuras corporativas, los servidores más críticos (bases de datos, controladores de dominio) residen en subredes internas aisladas sin acceso directo desde Internet. El **Pivoting** es la técnica que permite utilizar una máquina perimetral previamente auditada (como un servidor web o bastion host) como puente para alcanzar la red interna. El protocolo **SSH** incluye capacidades nativas extraordinarias para crear túneles cifrados. Con **Dynamic Port Forwarding (\\\\`ssh -D 1080\\\\`)**, SSH convierte el equipo local en un servidor proxy SOCKS5: combinando esto con **\\\\`proxychains4\\\\`**, cualquier herramienta de Kali Linux (como \\\\`nmap\\\\` o \\\\`curl\\\\`) puede enrutar su tráfico a través del túnel SSH como si se ejecutara físicamente dentro de la red privada.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Concepto de salto lateral (Pivoting) para alcanzar redes internas no enrutables.\n· Reenvío de puertos local con SSH (Local Port Forwarding: ssh -L local_port:target_ip:target_port).\n· Reenvío de puertos remoto (Remote Port Forwarding: ssh -R remote_port:local_ip:local_port).\n· Creación de túneles dinámicos SOCKS5 con SSH (Dynamic Port Forwarding: ssh -D socks_port).\n· Configuración y uso de Proxychains (/etc/proxychains4.conf) para canalizar herramientas como Nmap a través de proxies.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Concepto de salto lateral (Pivoting) para alcanzar redes internas no enrutables.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Concepto de salto lateral (Pivoting) para alcanzar redes internas no enrutables.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Concepto de salto lateral (Pivoting) para alcanzar redes internas no enrutables.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Reenvío de puertos local con SSH (Local Port Forwarding: ssh -L local_port:target_ip:target_port).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Reenvío de puertos local con SSH (Local Port Forwarding: ssh -L local_port:target_ip:target_port).» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Reenvío de puertos local con SSH (Local Port Forwarding: ssh -L local_port:target_ip:target_port).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Reenvío de puertos remoto (Remote Port Forwarding: ssh -R remote_port:local_ip:local_port).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Reenvío de puertos remoto (Remote Port Forwarding: ssh -R remote_port:local_ip:local_port).» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Reenvío de puertos remoto (Remote Port Forwarding: ssh -R remote_port:local_ip:local_port).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Creación de túneles dinámicos SOCKS5 con SSH (Dynamic Port Forwarding: ssh -D socks_port).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Creación de túneles dinámicos SOCKS5 con SSH (Dynamic Port Forwarding: ssh -D socks_port).» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Creación de túneles dinámicos SOCKS5 con SSH (Dynamic Port Forwarding: ssh -D socks_port).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Configuración y uso de Proxychains (/etc/proxychains4.conf) para canalizar herramientas como Nmap a través de proxies.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Configuración y uso de Proxychains (/etc/proxychains4.conf) para canalizar herramientas como Nmap a través de proxies.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Configuración y uso de Proxychains (/etc/proxychains4.conf) para canalizar herramientas como Nmap a través de proxies.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 2:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\n**Caso 3:** SOCs usan filtros BPF para aislar tráfico malicioso en incident response.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PIVOTING DE REDES, PORT FORWARDING Y TÚNELES SSH es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Identificación de configuraciones erróneas en permisos, binarios SUID/SGID, tareas cron vulnerables, capacidades del kernel (Capabilities) y GTFOBins. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX.",
      items: [
      ...
      content: "## 📘 Clase completa — AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nIdentificación de configuraciones erróneas en permisos, binarios SUID/SGID, tareas cron vulnerables, capacidades del kernel (Capabilities) y GTFOBins. La elevación de privilegios (Privilege Escalation) ocurre cuando un usuario con permisos restringidos aprovecha una falla de configuración para obtener acceso como superusuario (\\\\`root\\\\`). En Linux, los vectores más frecuentes son los permisos especiales **SUID (Set User ID)** y **sudo mal configurado**. Cuando un binario tiene el bit SUID activo (\\\\`-rwsr-xr-x\\\\`), se ejecuta con los privilegios del propietario del archivo (frecuentemente root) en lugar de los privilegios del usuario que lo invoca. El proyecto de investigación **GTFOBins** cataloga binarios estándar de Unix que, si se configuran con SUID o se permiten en \\\\`sudoers\\\\` sin restricciones, permiten ejecutar comandos arbitrarios o invocar shells con privilegios elevados.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Vectores comunes de mala configuración en sistemas operativos Linux.\n· Auditoría exhaustiva de binarios SUID (SetUID: 4000) y SGID (SetGID: 2000).\n· Inspección de privilegios sudo mal restringidos mediante 'sudo -l'.\n· Capacidades avanzadas del Kernel Linux con getcap / setcap (ej. cap_setuid).\n· El proyecto GTFOBins como referencia defensiva para auditar binarios con escape de shell.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Vectores comunes de mala configuración en sistemas operativos Linux.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Vectores comunes de mala configuración en sistemas operativos Linux.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Vectores comunes de mala configuración en sistemas operativos Linux.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Auditoría exhaustiva de binarios SUID (SetUID: 4000) y SGID (SetGID: 2000).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Auditoría exhaustiva de binarios SUID (SetUID: 4000) y SGID (SetGID: 2000).» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Auditoría exhaustiva de binarios SUID (SetUID: 4000) y SGID (SetGID: 2000).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Inspección de privilegios sudo mal restringidos mediante 'sudo -l'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección de privilegios sudo mal restringidos mediante 'sudo -l'.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección de privilegios sudo mal restringidos mediante 'sudo -l'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Capacidades avanzadas del Kernel Linux con getcap / setcap (ej. cap_setuid).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Capacidades avanzadas del Kernel Linux con getcap / setcap (ej. cap_setuid).» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Capacidades avanzadas del Kernel Linux con getcap / setcap (ej. cap_setuid).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — El proyecto GTFOBins como referencia defensiva para auditar binarios con escape de shell.\n\nTiempo sugerido al grabar: **7–9 minutos**. «El proyecto GTFOBins como referencia defensiva para auditar binarios con escape de shell.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «El proyecto GTFOBins como referencia defensiva para auditar binarios con escape de shell.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar AUDITORÍA DE PERMISOS, SUID/SGID Y ELEVACIÓN DE PRIVILEGIOS EN LINUX es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Cadena de custodia, cálculo de hashes de integridad (sha256sum), adquisición forense bit a bit con dd/dc3dd y análisis de artefactos con Sleuthkit y Binwalk. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA.",
      items: [
      ...
      content: "## 📘 Clase completa — ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nCadena de custodia, cálculo de hashes de integridad (sha256sum), adquisición forense bit a bit con dd/dc3dd y análisis de artefactos con Sleuthkit y Binwalk. El análisis forense digital (Digital Forensics and Incident Response - DFIR) tiene como objetivo identificar, preservar, analizar y presentar evidencia digital garantizando su validez jurídica y técnica. El primer principio rector es el **Orden de Volatilidad**: la información en memoria RAM, registros de CPU y sockets activos debe capturarse antes que el almacenamiento secundario en disco duro. Al realizar una copia de un disco sospechoso, nunca se interactúa con la evidencia original; en su lugar, se genera una **imagen forense bit a bit** utilizando herramientas como \\\\`dd\\\\` o \\\\`dc3dd\\\\` y se calcula de inmediato su resumen criptográfico (**SHA-256**) para certificar que la copia es idéntica y no ha sufrido alteraciones.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Principios de la evidencia digital: orden de volatilidad y preservación de la cadena de custodia.\n· Cálculo y verificación de hashes de integridad criptográfica (sha256sum, md5sum).\n· Adquisición forense de discos y particiones mediante dd y dc3dd con control de errores.\n· Extracción de archivos incrustados y firmas binarias mediante binwalk y foremost.\n· Inspección de estructuras de sistemas de archivos y recuperación con The Sleuth Kit (fls, icat).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Principios de la evidencia digital: orden de volatilidad y preservación de la cadena de custodia.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Principios de la evidencia digital: orden de volatilidad y preservación de la cadena de custodia.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Principios de la evidencia digital: orden de volatilidad y preservación de la cadena de custodia.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Cálculo y verificación de hashes de integridad criptográfica (sha256sum, md5sum).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Cálculo y verificación de hashes de integridad criptográfica (sha256sum, md5sum).» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Cálculo y verificación de hashes de integridad criptográfica (sha256sum, md5sum).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Adquisición forense de discos y particiones mediante dd y dc3dd con control de errores.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Adquisición forense de discos y particiones mediante dd y dc3dd con control de errores.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Adquisición forense de discos y particiones mediante dd y dc3dd con control de errores.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Extracción de archivos incrustados y firmas binarias mediante binwalk y foremost.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Extracción de archivos incrustados y firmas binarias mediante binwalk y foremost.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Extracción de archivos incrustados y firmas binarias mediante binwalk y foremost.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Inspección de estructuras de sistemas de archivos y recuperación con The Sleuth Kit (fls, icat).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Inspección de estructuras de sistemas de archivos y recuperación con The Sleuth Kit (fls, icat).» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Inspección de estructuras de sistemas de archivos y recuperación con The Sleuth Kit (fls, icat).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ANÁLISIS FORENSE DIGITAL BÁSICO Y ADQUISICIÓN DE EVIDENCIA es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Estructura de bitácoras en /var/log/, filtrado y correlación de eventos con grep/awk, detección de ataques de fuerza bruta y análisis de registros de servidores web. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES.",
      items: [
      ...
      content: "## 📘 Clase completa — ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstructura de bitácoras en /var/log/, filtrado y correlación de eventos con grep/awk, detección de ataques de fuerza bruta y análisis de registros de servidores web. Los registros de eventos (logs) constituyen la fuente primordial de verdad para la detección de anomalías y la investigación post-incidente. En distribuciones basadas en Debian como Kali Linux, los intentos de autenticación (tanto exitosos como fallidos) se almacenan en \\\\`/var/log/auth.log\\\\`. El análisis manual o automatizado de logs mediante herramientas de procesamiento de texto (\\\\`grep\\\\`, \\\\`awk\\\\`, \\\\`cut\\\\`, \\\\`sort\\\\`, \\\\`uniq\\\\`) permite a un analista reconstruir la línea de tiempo de un ataque: identificar direcciones IP de origen que ejecutan ataques de fuerza bruta contra el servicio SSH, detectar picos de errores 404 causados por herramientas automatizadas de fuzzing web o aislar intentos de inyección SQL en las URLs solicitadas.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Mapa de bitácoras del sistema (/var/log/auth.log, syslog, /var/log/apache2/access.log).\n· Filtrado y conteo de intentos fallidos de autenticación SSH (Failed password).\n· Procesamiento y agregación de logs de acceso web con awk, sort y uniq -c.\n· Detección de patrones de inyección SQL, escaneos de rutas y User-Agents anómalos.\n· Principios de correlación de eventos y reenvío centralizado a sistemas SIEM.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Mapa de bitácoras del sistema (/var/log/auth.log, syslog, /var/log/apache2/access.log).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa de bitácoras del sistema (/var/log/auth.log, syslog, /var/log/apache2/access.log).» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa de bitácoras del sistema (/var/log/auth.log, syslog, /var/log/apache2/access.log).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Filtrado y conteo de intentos fallidos de autenticación SSH (Failed password).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Filtrado y conteo de intentos fallidos de autenticación SSH (Failed password).» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Filtrado y conteo de intentos fallidos de autenticación SSH (Failed password).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Procesamiento y agregación de logs de acceso web con awk, sort y uniq -c.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Procesamiento y agregación de logs de acceso web con awk, sort y uniq -c.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Procesamiento y agregación de logs de acceso web con awk, sort y uniq -c.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Detección de patrones de inyección SQL, escaneos de rutas y User-Agents anómalos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Detección de patrones de inyección SQL, escaneos de rutas y User-Agents anómalos.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Detección de patrones de inyección SQL, escaneos de rutas y User-Agents anómalos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Principios de correlación de eventos y reenvío centralizado a sistemas SIEM.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Principios de correlación de eventos y reenvío centralizado a sistemas SIEM.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Principios de correlación de eventos y reenvío centralizado a sistemas SIEM.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ANÁLISIS DE LOGS DEL SISTEMA Y DETECCIÓN DE INTRUSIONES es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Políticas de filtrado por defecto (DROP/ACCEPT), cadenas INPUT/OUTPUT/FORWARD, inspección de estado (conntrack) con IPTables, migración a NFTables y configuración con UFW. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW.",
      items: [
      ...
      content: "## 📘 Clase completa — BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nPolíticas de filtrado por defecto (DROP/ACCEPT), cadenas INPUT/OUTPUT/FORWARD, inspección de estado (conntrack) con IPTables, migración a NFTables y configuración con UFW. El bastionado (Hardening) de sistemas consiste en reducir la superficie de ataque de un servidor eliminando servicios innecesarios, aplicando el principio de mínimo privilegio y configurando cortafuegos con estado. En el kernel de Linux, el filtrado de paquetes ha sido gestionado históricamente por **IPTables** y actualmente por **NFTables**. Un firewall robusto aplica una **política por defecto DROP** (descartar todo el tráfico entrante salvo lo explícitamente permitido). Mediante el módulo de seguimiento de conexiones **conntrack**, el firewall permite automáticamente los paquetes de respuestas legítimas (\\\\`ESTABLISHED,RELATED\\\\`) para conexiones que el propio servidor inició, bloqueando cualquier intento de conexión entrante no autorizado a puertos cerrados.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Principios de Hardening y defensa en profundidad en servidores Linux.\n· Estructura de tablas y cadenas en IPTables: filter, nat, mangle y cadenas INPUT/OUTPUT/FORWARD.\n· Filtrado con seguimiento de estado de conexiones (Stateful Firewall con conntrack: ESTABLISHED, RELATED).\n· Configuración simplificada de cortafuegos perimetral mediante UFW (Uncomplicated Firewall).\n· Arquitectura moderna de filtrado del Kernel Linux con NFTables (nft).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Principios de Hardening y defensa en profundidad en servidores Linux.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Principios de Hardening y defensa en profundidad en servidores Linux.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Principios de Hardening y defensa en profundidad en servidores Linux.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Estructura de tablas y cadenas en IPTables: filter, nat, mangle y cadenas INPUT/OUTPUT/FORWARD.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Estructura de tablas y cadenas en IPTables: filter, nat, mangle y cadenas INPUT/OUTPUT/FORWARD.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Estructura de tablas y cadenas en IPTables: filter, nat, mangle y cadenas INPUT/OUTPUT/FORWARD.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Filtrado con seguimiento de estado de conexiones (Stateful Firewall con conntrack: ESTABLISHED, RELATED).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Filtrado con seguimiento de estado de conexiones (Stateful Firewall con conntrack: ESTABLISHED, RELATED).» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Filtrado con seguimiento de estado de conexiones (Stateful Firewall con conntrack: ESTABLISHED, RELATED).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Configuración simplificada de cortafuegos perimetral mediante UFW (Uncomplicated Firewall).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Configuración simplificada de cortafuegos perimetral mediante UFW (Uncomplicated Firewall).» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Configuración simplificada de cortafuegos perimetral mediante UFW (Uncomplicated Firewall).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Arquitectura moderna de filtrado del Kernel Linux con NFTables (nft).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Arquitectura moderna de filtrado del Kernel Linux con NFTables (nft).» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Arquitectura moderna de filtrado del Kernel Linux con NFTables (nft).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 2:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\n**Caso 3:** Red teams reportan severidad con CVSS v3.1 para priorizar parches.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar BASTIONADO DE SISTEMAS (HARDENING), CORTAFUEGOS IPTABLES/NFTABLES Y UFW es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
    ...
    },
{
      ...
      description: "Fases formales de una auditoría de seguridad, delimitación de alcance (Scope), acuerdos de nivel de servicio (SLA/NDA), matriz de severidad CVSS v3.1 y redacción de informes ejecutivos y técnicos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS.",
      items: [
      ...
      content: "## 📘 Clase completa — METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nFases formales de una auditoría de seguridad, delimitación de alcance (Scope), acuerdos de nivel de servicio (SLA/NDA), matriz de severidad CVSS v3.1 y redacción de informes ejecutivos y técnicos. La ejecución de pruebas de penetración profesionales no se define por el uso aislado de herramientas, sino por la rigurosa aplicación de una **metodología formal** y un marco de **responsabilidad ética y legal**. Estándares como el **PTES (Penetration Testing Execution Standard)** estructuran la evaluación en siete fases secuenciales: Pre-engagement (acuerdos y alcance), Recolección de Inteligencia, Modelado de Amenazas, Análisis de Vulnerabilidades, Explotación, Post-explotación y Reporte. El entregable más valioso para la organización cliente es el **Informe Final**: este debe contener un Resumen Ejecutivo orientado a la dirección de la empresa (sin tecnicismos excesivos, destacando el impacto en el negocio) y una Sección Técnica exhaustiva donde cada vulnerabilidad se clasifica según el estándar **CVSS v3.1** (Base Score de 0.0 a 10.0), acompañada de pruebas de concepto reproducibles y recomendaciones de mitigación claras y verificables.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Fases metodológicas del estándar PTES (Penetration Testing Execution Standard).\n· Marco de evaluación de seguridad NIST SP 800-115 y directrices éticas.\n· Definición de alcance (Rules of Engagement - RoE, Scope y acuerdos de confidencialidad NDA).\n· Cálculo de severidad de vulnerabilidades mediante el estándar Common Vulnerability Scoring System (CVSS v3.1).\n· Estructura formal de un reporte de auditoría: Resumen Ejecutivo vs Detalle Técnico con pasos de reproducción (PoC) y remediación.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Fases metodológicas del estándar PTES (Penetration Testing Execution Standard).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Fases metodológicas del estándar PTES (Penetration Testing Execution Standard).» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Fases metodológicas del estándar PTES (Penetration Testing Execution Standard).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Marco de evaluación de seguridad NIST SP 800-115 y directrices éticas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Marco de evaluación de seguridad NIST SP 800-115 y directrices éticas.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Marco de evaluación de seguridad NIST SP 800-115 y directrices éticas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Definición de alcance (Rules of Engagement - RoE, Scope y acuerdos de confidencialidad NDA).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Definición de alcance (Rules of Engagement - RoE, Scope y acuerdos de confidencialidad NDA).» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Definición de alcance (Rules of Engagement - RoE, Scope y acuerdos de confidencialidad NDA).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Cálculo de severidad de vulnerabilidades mediante el estándar Common Vulnerability Scoring System (CVSS v3.1).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Cálculo de severidad de vulnerabilidades mediante el estándar Common Vulnerability Scoring System (CVSS v3.1).» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Cálculo de severidad de vulnerabilidades mediante el estándar Common Vulnerability Scoring System (CVSS v3.1).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Estructura formal de un reporte de auditoría: Resumen Ejecutivo vs Detalle Técnico con pasos de reproducción (PoC) y remediación.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Estructura formal de un reporte de auditoría: Resumen Ejecutivo vs Detalle Técnico con pasos de reproducción (PoC) y remediación.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Estructura formal de un reporte de auditoría: Resumen Ejecutivo vs Detalle Técnico con pasos de reproducción (PoC) y remediación.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS dentro de auditoría de redes, diagnóstico Linux y ciberseguridad práctica.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 2:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\n**Caso 3:** Pentests PTES documentan hallazgos con Nmap, Nikto y evidencia Tcpdump.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar METODOLOGÍA DE PENTESTING, ESTÁNDARES (PTES/NIST) Y REPORTE CVSS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
