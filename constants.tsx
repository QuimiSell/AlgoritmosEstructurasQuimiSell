...
export const COURSE_MODULES: Module[] = [{
    ...
    description: "La ciencia de medir la eficiencia. Entender cómo escala el código con los datos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar FUNDAMENTOS Y BIG-O.",
    items: [
    ...
    content: "## 📘 Clase completa — FUNDAMENTOS Y BIG-O\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nLa ciencia de medir la eficiencia. Entender cómo escala el código con los datos. La piedra angular de las Ciencias de la Computación. La notación Big-O nos permite comparar algoritmos objetivamente. No medimos segundos, medimos el crecimiento de las operaciones. Por ejemplo, en un algoritmo O(n²), si duplicas los datos, el tiempo se cuadruplica. Dominar el análisis asintótico es la diferencia entre un programador y un ingeniero de software. Las constantes y los coeficientes menores se descartan (ej. 3n + 5 es simplemente O(n)) porque para entradas muy grandes (n tendiendo a infinito), los términos multiplicativos o aditivos constantes pierden relevancia frente a los términos exponenciales o polinómicos dominantes.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Notación O, Ω, Θ: Límites superiores, inferiores y ajustados.\n· Análisis Asintótico: Eliminación de constantes y términos no dominantes.\n· Best/Worst/Average Case: Por qué casi siempre nos importa el peor caso.\n· Trade-offs: El equilibrio sagrado entre Tiempo y Espacio.\n· Recursión: Análisis de profundidad de pila y casos base.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de FUNDAMENTOS Y BIG-O.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Notación O, Ω, Θ: Límites superiores, inferiores y ajustados.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Notación O, Ω, Θ: Límites superiores, inferiores y ajustados.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Notación O, Ω, Θ: Límites superiores, inferiores y ajustados.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Análisis Asintótico: Eliminación de constantes y términos no dominantes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Análisis Asintótico: Eliminación de constantes y términos no dominantes.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Análisis Asintótico: Eliminación de constantes y términos no dominantes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Best/Worst/Average Case: Por qué casi siempre nos importa el peor caso.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Best/Worst/Average Case: Por qué casi siempre nos importa el peor caso.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Best/Worst/Average Case: Por qué casi siempre nos importa el peor caso.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Trade-offs: El equilibrio sagrado entre Tiempo y Espacio.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Trade-offs: El equilibrio sagrado entre Tiempo y Espacio.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Trade-offs: El equilibrio sagrado entre Tiempo y Espacio.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Recursión: Análisis de profundidad de pila y casos base.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Recursión: Análisis de profundidad de pila y casos base.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Recursión: Análisis de profundidad de pila y casos base.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de FUNDAMENTOS Y BIG-O.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de FUNDAMENTOS Y BIG-O.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de FUNDAMENTOS Y BIG-O.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en FUNDAMENTOS Y BIG-O dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 2:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 3:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume FUNDAMENTOS Y BIG-O en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar FUNDAMENTOS Y BIG-O es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Organización secuencial: desde la memoria contigua hasta los punteros. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ESTRUCTURAS LINEALES.",
    items: [
    ...
    content: "## 📘 Clase completa — ESTRUCTURAS LINEALES\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nOrganización secuencial: desde la memoria contigua hasta los punteros. Las estructuras lineales definen cómo fluyen los datos. Los Arrays brillan en acceso aleatorio (O(1)), pero sufren en inserciones intermedias (O(n)). Las Linked Lists invierten esto: inserción rápida pero búsqueda lenta. Entender cuándo usar cada una es vital para optimizar el rendimiento del sistema. El redimensionamiento de arreglos dinámicos duplica la capacidad del arreglo cuando se llena, lo que cuesta O(n) para copiar elementos, pero al promediarse en muchas inserciones sucesivas, el costo es de O(1) amortizado.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Dynamic Arrays: Estrategias de redimensionamiento (amortización O(1)).\n· Linked Lists: Simples, dobles y circulares. El poder de los punteros.\n· Stacks (LIFO): Gestión de llamadas (Call Stack) y balanceo de símbolos.\n· Queues (FIFO): Buffers, colas de impresión y manejo de procesos.\n· Deques: Colas de doble extremo para máxima flexibilidad.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ESTRUCTURAS LINEALES.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Dynamic Arrays: Estrategias de redimensionamiento (amortización O(1)).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Dynamic Arrays: Estrategias de redimensionamiento (amortización O(1)).» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Dynamic Arrays: Estrategias de redimensionamiento (amortización O(1)).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Linked Lists: Simples, dobles y circulares. El poder de los punteros.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Linked Lists: Simples, dobles y circulares. El poder de los punteros.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Linked Lists: Simples, dobles y circulares. El poder de los punteros.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Stacks (LIFO): Gestión de llamadas (Call Stack) y balanceo de símbolos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Stacks (LIFO): Gestión de llamadas (Call Stack) y balanceo de símbolos.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Stacks (LIFO): Gestión de llamadas (Call Stack) y balanceo de símbolos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Queues (FIFO): Buffers, colas de impresión y manejo de procesos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Queues (FIFO): Buffers, colas de impresión y manejo de procesos.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Queues (FIFO): Buffers, colas de impresión y manejo de procesos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Deques: Colas de doble extremo para máxima flexibilidad.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Deques: Colas de doble extremo para máxima flexibilidad.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Deques: Colas de doble extremo para máxima flexibilidad.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ESTRUCTURAS LINEALES.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ESTRUCTURAS LINEALES.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ESTRUCTURAS LINEALES.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ESTRUCTURAS LINEALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 2:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 3:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ESTRUCTURAS LINEALES en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ESTRUCTURAS LINEALES es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "El arte de la búsqueda instantánea mediante funciones de dispersión. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ESTRUCTURAS AVANZADAS (HASH).",
    items: [
    ...
    content: "## 📘 Clase completa — ESTRUCTURAS AVANZADAS (HASH)\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEl arte de la búsqueda instantánea mediante funciones de dispersión. Una Tabla Hash es magia técnica: convierte cualquier clave en un índice mediante una función de dispersión. El desafío es la colisión (cuando dos claves quieren el mismo sitio). Un buen ingeniero diseña funciones hash que minimicen esto, manteniendo búsquedas promedio de O(1). El Factor de Carga (Load Factor, n/m) determina cuándo redimensionar la tabla; si este valor supera el 70% o 80%, las colisiones crecen drásticamente. En el peor caso absoluto, si todos los elementos colisionan en la misma celda de Chaining, la búsqueda se degrada a O(n).\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Hash Functions: Determinismo, uniformidad y eficiencia.\n· Collision Resolution: Chaining (listas) vs Open Addressing (Probing).\n· Load Factor: Cuándo redimensionar para mantener el O(1) promedio.\n· Sets y Maps: Implementaciones basadas en hashing vs árboles.\n· Aplicaciones: Caches, bases de datos y criptografía básica.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ESTRUCTURAS AVANZADAS (HASH).\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Hash Functions: Determinismo, uniformidad y eficiencia.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Hash Functions: Determinismo, uniformidad y eficiencia.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Hash Functions: Determinismo, uniformidad y eficiencia.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Collision Resolution: Chaining (listas) vs Open Addressing (Probing).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Collision Resolution: Chaining (listas) vs Open Addressing (Probing).» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Collision Resolution: Chaining (listas) vs Open Addressing (Probing).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Load Factor: Cuándo redimensionar para mantener el O(1) promedio.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Load Factor: Cuándo redimensionar para mantener el O(1) promedio.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Load Factor: Cuándo redimensionar para mantener el O(1) promedio.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Sets y Maps: Implementaciones basadas en hashing vs árboles.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Sets y Maps: Implementaciones basadas en hashing vs árboles.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Sets y Maps: Implementaciones basadas en hashing vs árboles.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aplicaciones: Caches, bases de datos y criptografía básica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicaciones: Caches, bases de datos y criptografía básica.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicaciones: Caches, bases de datos y criptografía básica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ESTRUCTURAS AVANZADAS (HASH).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ESTRUCTURAS AVANZADAS (HASH).» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ESTRUCTURAS AVANZADAS (HASH).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ESTRUCTURAS AVANZADAS (HASH) dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 2:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 3:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ESTRUCTURAS AVANZADAS (HASH) en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ESTRUCTURAS AVANZADAS (HASH) es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Estructuras ramificadas para búsquedas y clasificaciones ultra-rápidas. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ÁRBOLES Y JERARQUÍAS.",
    items: [
    ...
    content: "## 📘 Clase completa — ÁRBOLES Y JERARQUÍAS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstructuras ramificadas para búsquedas y clasificaciones ultra-rápidas. Los árboles permiten organizar datos jerárquicamente. Un Árbol de Búsqueda Binaria balanceado reduce una búsqueda de un millón de elementos a solo 20 comparaciones (O(log n)). Los BST no balanceados pueden degenerar en listas lineales de O(n) si se insertan ordenados. Los árboles AVL y Red-Black se auto-balancean mediante rotaciones de nodos, asegurando altura logarítmica. Los Heaps mantienen el máximo (Max-Heap) o mínimo (Min-Heap) en la raíz para colas de prioridad O(1) de acceso y O(log n) de inserción/borrado. Los Tries optimizan búsquedas de prefijos y los Árboles B/B+ reducen lecturas físicas en bases de datos mediante alta ramificación.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· BST (Binary Search Tree): Izquierda menor, derecha mayor.\n· Balanceo: Por qué un árbol degenerado es solo una lista lenta.\n· AVL y Red-Black: Rotaciones automáticas para mantener O(log n).\n· Heaps: Max-Heap y Min-Heap para colas de prioridad eficientes.\n· Tries: El secreto detrás del autocompletado en buscadores.\n· B-Trees: La estructura que sostiene a casi todas las bases de datos SQL.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ÁRBOLES Y JERARQUÍAS.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — BST (Binary Search Tree): Izquierda menor, derecha mayor.\n\nTiempo sugerido al grabar: **7–9 minutos**. «BST (Binary Search Tree): Izquierda menor, derecha mayor.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «BST (Binary Search Tree): Izquierda menor, derecha mayor.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Balanceo: Por qué un árbol degenerado es solo una lista lenta.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Balanceo: Por qué un árbol degenerado es solo una lista lenta.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Balanceo: Por qué un árbol degenerado es solo una lista lenta.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — AVL y Red-Black: Rotaciones automáticas para mantener O(log n).\n\nTiempo sugerido al grabar: **7–9 minutos**. «AVL y Red-Black: Rotaciones automáticas para mantener O(log n).» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «AVL y Red-Black: Rotaciones automáticas para mantener O(log n).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Heaps: Max-Heap y Min-Heap para colas de prioridad eficientes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Heaps: Max-Heap y Min-Heap para colas de prioridad eficientes.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Heaps: Max-Heap y Min-Heap para colas de prioridad eficientes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Tries: El secreto detrás del autocompletado en buscadores.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Tries: El secreto detrás del autocompletado en buscadores.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Tries: El secreto detrás del autocompletado en buscadores.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — B-Trees: La estructura que sostiene a casi todas las bases de datos SQL.\n\nTiempo sugerido al grabar: **7–9 minutos**. «B-Trees: La estructura que sostiene a casi todas las bases de datos SQL.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «B-Trees: La estructura que sostiene a casi todas las bases de datos SQL.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Mapa mental de ÁRBOLES Y JERARQUÍAS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ÁRBOLES Y JERARQUÍAS.» es esencial en ÁRBOLES Y JERARQUÍAS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ÁRBOLES Y JERARQUÍAS.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 2:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 3:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ÁRBOLES Y JERARQUÍAS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ÁRBOLES Y JERARQUÍAS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Modelando el mundo: redes sociales, GPS y dependencias. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar TEORÍA DE GRAFOS.",
    items: [
    ...
    content: "## 📘 Clase completa — TEORÍA DE GRAFOS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nModelando el mundo: redes sociales, GPS y dependencias. Todo es un grafo: Internet, las neuronas, el metro. BFS recorre radialmente nivel por nivel usando una Cola (Queue), ideal para distancias mínimas en grafos no ponderados. DFS explora ramas a profundidad usando una Pila (Stack) o recursión, útil para ciclos y ordenamiento topológico. Dijkstra resuelve rutas más cortas con pesos positivos usando colas de prioridad. A* acelera Dijkstra incorporando heurísticas de distancia al destino. Prim y Kruskal calculan el Árbol de Expansión Mínima (MST) que conecta todos los nodos con el menor peso acumulado total.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Representaciones: Matriz vs Lista de adyacencia (Espacio vs Tiempo).\n· BFS y DFS: Exploración por niveles vs profundidad extrema.\n· Dijkstra y A*: Algoritmos de navegación y búsqueda inteligente.\n· MST: Prim y Kruskal para optimizar tendidos de cables o rutas.\n· Orden Topológico: Gestión de dependencias en compiladores y proyectos.\n· Ciclos y Conectividad: Detectando bucles infinitos en sistemas.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de TEORÍA DE GRAFOS.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Representaciones: Matriz vs Lista de adyacencia (Espacio vs Tiempo).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Representaciones: Matriz vs Lista de adyacencia (Espacio vs Tiempo).» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Representaciones: Matriz vs Lista de adyacencia (Espacio vs Tiempo).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — BFS y DFS: Exploración por niveles vs profundidad extrema.\n\nTiempo sugerido al grabar: **7–9 minutos**. «BFS y DFS: Exploración por niveles vs profundidad extrema.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «BFS y DFS: Exploración por niveles vs profundidad extrema.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Dijkstra y A*: Algoritmos de navegación y búsqueda inteligente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Dijkstra y A*: Algoritmos de navegación y búsqueda inteligente.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Dijkstra y A*: Algoritmos de navegación y búsqueda inteligente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — MST: Prim y Kruskal para optimizar tendidos de cables o rutas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «MST: Prim y Kruskal para optimizar tendidos de cables o rutas.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «MST: Prim y Kruskal para optimizar tendidos de cables o rutas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Orden Topológico: Gestión de dependencias en compiladores y proyectos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Orden Topológico: Gestión de dependencias en compiladores y proyectos.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Orden Topológico: Gestión de dependencias en compiladores y proyectos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Ciclos y Conectividad: Detectando bucles infinitos en sistemas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Ciclos y Conectividad: Detectando bucles infinitos en sistemas.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Ciclos y Conectividad: Detectando bucles infinitos en sistemas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Mapa mental de TEORÍA DE GRAFOS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de TEORÍA DE GRAFOS.» es esencial en TEORÍA DE GRAFOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de TEORÍA DE GRAFOS.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\n**Caso 2:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\n**Caso 3:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n· Saltarse la autoevaluación y avanzar sin dominar el 70% de aciertos.\n· Grabar leyendo texto plano en lugar de explicar con ejemplos propios.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume TEORÍA DE GRAFOS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar TEORÍA DE GRAFOS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Del caos al orden: la eficiencia de la organización de datos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ALGORITMOS DE ORDENAMIENTO.",
    items: [
    ...
    content: "## 📘 Clase completa — ALGORITMOS DE ORDENAMIENTO\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nDel caos al orden: la eficiencia de la organización de datos. Ordenar es fundamental para búsquedas eficientes. Merge Sort es estable (mantiene el orden original de elementos con valores iguales) pero consume O(n) memoria extra. Quick Sort es in-place (no requiere memoria extra) pero su peor caso es O(n²) si el pivote no está optimizado. Matemáticamente, ningún ordenamiento basado en comparaciones puede ser menor a O(n log n). Algoritmos de ordenamiento no basados en comparaciones (como Counting Sort o Radix Sort) pueden lograr O(n) pero requieren restricciones en el rango de los datos.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Básicos (O(n²)): Bubble, Selection, Insertion (buenos para sets pequeños).\n· Eficientes (O(n log n)): Merge Sort (estable) y Quick Sort (in-place).\n· Especiales: Counting y Radix Sort (superando el límite de comparación).\n· Estabilidad: Por qué importa mantener el orden relativo de elementos iguales.\n· Timsort: El algoritmo híbrido real detrás de Python y Java.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ALGORITMOS DE ORDENAMIENTO.\n· Preguntas tipo entrevista técnica.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Básicos (O(n²)): Bubble, Selection, Insertion (buenos para sets pequeños).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Básicos (O(n²)): Bubble, Selection, Insertion (buenos para sets pequeños).» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Básicos (O(n²)): Bubble, Selection, Insertion (buenos para sets pequeños).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Eficientes (O(n log n)): Merge Sort (estable) y Quick Sort (in-place).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Eficientes (O(n log n)): Merge Sort (estable) y Quick Sort (in-place).» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Eficientes (O(n log n)): Merge Sort (estable) y Quick Sort (in-place).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Especiales: Counting y Radix Sort (superando el límite de comparación).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Especiales: Counting y Radix Sort (superando el límite de comparación).» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Especiales: Counting y Radix Sort (superando el límite de comparación).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Estabilidad: Por qué importa mantener el orden relativo de elementos iguales.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Estabilidad: Por qué importa mantener el orden relativo de elementos iguales.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Estabilidad: Por qué importa mantener el orden relativo de elementos iguales.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Timsort: El algoritmo híbrido real detrás de Python y Java.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Timsort: El algoritmo híbrido real detrás de Python y Java.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Timsort: El algoritmo híbrido real detrás de Python y Java.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Mapa mental de ALGORITMOS DE ORDENAMIENTO.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ALGORITMOS DE ORDENAMIENTO.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ALGORITMOS DE ORDENAMIENTO.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ALGORITMOS DE ORDENAMIENTO dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 2:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 3:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ALGORITMOS DE ORDENAMIENTO en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ALGORITMOS DE ORDENAMIENTO es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Encontrar la aguja en el pajar de datos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ALGORITMOS DE BÚSQUEDA.",
    items: [
    ...
    content: "## 📘 Clase completa — ALGORITMOS DE BÚSQUEDA\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEncontrar la aguja en el pajar de datos. La Búsqueda Binaria reduce el espacio de búsqueda a la mitad en cada paso (O(log n)), requiriendo obligatoriamente que la colección esté ordenada. La técnica de Dos Punteros (Two Pointers) optimiza búsquedas de sumas o pares en colecciones ordenadas en tiempo O(n). La Ventana Deslizante (Sliding Window) analiza subarreglos eficientemente. Los algoritmos A* usan funciones heurísticas que estiman la distancia al destino para optimizar el recorrido frente a Dijkstra.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Búsqueda Binaria: El poder de dividir y conquistar (O(log n)).\n· Técnicas de Punteros: Two Pointers y Sliding Window.\n· Búsqueda Heurística: Introducción a la IA con algoritmos 'Best-First'.\n· Búsqueda en Grafos: Comparativa entre Uniform-cost y Greedy.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ALGORITMOS DE BÚSQUEDA.\n· Preguntas tipo entrevista técnica.\n· Glosario: 5 términos que defines sin diccionario.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Búsqueda Binaria: El poder de dividir y conquistar (O(log n)).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Búsqueda Binaria: El poder de dividir y conquistar (O(log n)).» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Búsqueda Binaria: El poder de dividir y conquistar (O(log n)).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Técnicas de Punteros: Two Pointers y Sliding Window.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Técnicas de Punteros: Two Pointers y Sliding Window.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Técnicas de Punteros: Two Pointers y Sliding Window.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Búsqueda Heurística: Introducción a la IA con algoritmos 'Best-First'.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Búsqueda Heurística: Introducción a la IA con algoritmos 'Best-First'.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Búsqueda Heurística: Introducción a la IA con algoritmos 'Best-First'.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Búsqueda en Grafos: Comparativa entre Uniform-cost y Greedy.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Búsqueda en Grafos: Comparativa entre Uniform-cost y Greedy.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Búsqueda en Grafos: Comparativa entre Uniform-cost y Greedy.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Mapa mental de ALGORITMOS DE BÚSQUEDA.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ALGORITMOS DE BÚSQUEDA.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ALGORITMOS DE BÚSQUEDA.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Glosario: 5 términos que defines sin diccionario.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Glosario: 5 términos que defines sin diccionario.» es esencial en ALGORITMOS DE BÚSQUEDA dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Glosario: 5 términos que defines sin diccionario.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 2:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\n**Caso 3:** Google Maps modela grafos urbanos; Dijkstra/A* calculan rutas en tiempo real.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ALGORITMOS DE BÚSQUEDA en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ALGORITMOS DE BÚSQUEDA es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Estrategias de diseño para problemas aparentemente imposibles. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar PARADIGMAS AVANZADOS.",
    items: [
    ...
    content: "## 📘 Clase completa — PARADIGMAS AVANZADOS\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nEstrategias de diseño para problemas aparentemente imposibles. La Programación Dinámica (DP) guarda soluciones de subproblemas superpuestos para no calcularlos dos veces, reduciendo tiempos exponenciales a polinomiales. Memoización es el enfoque Top-Down (recursivo con caché). Tabulación es el enfoque Bottom-Up (tabla iterativa de menor a mayor). Greedy toma decisiones locales óptimas instantáneas, sin retroceder. Backtracking realiza una búsqueda en profundidad sistemática sobre árboles de decisiones, podando ramas inviables para optimizar la búsqueda.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Programación Dinámica: Memoización vs Tabulación. No repitas trabajo.\n· Divide y Vencerás: Descomposición de problemas masivos.\n· Algoritmos Voraces (Greedy): Decisiones óptimas locales para óptimos globales.\n· Backtracking: Poda de árboles de decisión (N-Queens, Sudoku).\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de PARADIGMAS AVANZADOS.\n· Preguntas tipo entrevista técnica.\n· Glosario: 5 términos que defines sin diccionario.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Programación Dinámica: Memoización vs Tabulación. No repitas trabajo.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Programación Dinámica: Memoización vs Tabulación. No repitas trabajo.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Programación Dinámica: Memoización vs Tabulación. No repitas trabajo.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Divide y Vencerás: Descomposición de problemas masivos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Divide y Vencerás: Descomposición de problemas masivos.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Divide y Vencerás: Descomposición de problemas masivos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Algoritmos Voraces (Greedy): Decisiones óptimas locales para óptimos globales.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Algoritmos Voraces (Greedy): Decisiones óptimas locales para óptimos globales.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Algoritmos Voraces (Greedy): Decisiones óptimas locales para óptimos globales.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Backtracking: Poda de árboles de decisión (N-Queens, Sudoku).\n\nTiempo sugerido al grabar: **7–9 minutos**. «Backtracking: Poda de árboles de decisión (N-Queens, Sudoku).» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Backtracking: Poda de árboles de decisión (N-Queens, Sudoku).» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Mapa mental de PARADIGMAS AVANZADOS.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de PARADIGMAS AVANZADOS.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de PARADIGMAS AVANZADOS.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Glosario: 5 términos que defines sin diccionario.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Glosario: 5 términos que defines sin diccionario.» es esencial en PARADIGMAS AVANZADOS dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Glosario: 5 términos que defines sin diccionario.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\n**Caso 2:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\n**Caso 3:** Redis elige estructuras (hash, zset) según la complejidad requerida por operación.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume PARADIGMAS AVANZADOS en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar PARADIGMAS AVANZADOS es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Optimizando para casos de uso extremos y masivos. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar ESTRUCTURAS ESPECIALES.",
    items: [
    ...
    content: "## 📘 Clase completa — ESTRUCTURAS ESPECIALES\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nOptimizando para casos de uso extremos y masivos. Los Filtros de Bloom son estructuras probabilísticas compactas que afirman con certeza si un elemento NO está en un conjunto, aunque tienen un margen de falsos positivos (pero 0% falsos negativos). Las cachés LRU expulsan el elemento menos usado recientemente cuando se llenan. Los Segment Trees representan intervalos para consultas y actualizaciones de rango en O(log n). DSU gestiona la unión e identificación de pertenencia de elementos a conjuntos disjuntos de forma casi constante.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Filtros de Bloom: ¿Está este elemento? Probablemente sí o definitivamente no.\n· LRU Cache: Gestión de memoria basada en uso reciente.\n· Segment Trees: Consultas de rango ultra-rápidas.\n· Disjoint Set Union (DSU): Agrupamiento dinámico y detección de ciclos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de ESTRUCTURAS ESPECIALES.\n· Preguntas tipo entrevista técnica.\n· Glosario: 5 términos que defines sin diccionario.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Filtros de Bloom: ¿Está este elemento? Probablemente sí o definitivamente no.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Filtros de Bloom: ¿Está este elemento? Probablemente sí o definitivamente no.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Filtros de Bloom: ¿Está este elemento? Probablemente sí o definitivamente no.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — LRU Cache: Gestión de memoria basada en uso reciente.\n\nTiempo sugerido al grabar: **7–9 minutos**. «LRU Cache: Gestión de memoria basada en uso reciente.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «LRU Cache: Gestión de memoria basada en uso reciente.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Segment Trees: Consultas de rango ultra-rápidas.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Segment Trees: Consultas de rango ultra-rápidas.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Segment Trees: Consultas de rango ultra-rápidas.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — Disjoint Set Union (DSU): Agrupamiento dinámico y detección de ciclos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Disjoint Set Union (DSU): Agrupamiento dinámico y detección de ciclos.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Disjoint Set Union (DSU): Agrupamiento dinámico y detección de ciclos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Mapa mental de ESTRUCTURAS ESPECIALES.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de ESTRUCTURAS ESPECIALES.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de ESTRUCTURAS ESPECIALES.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Glosario: 5 términos que defines sin diccionario.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Glosario: 5 términos que defines sin diccionario.» es esencial en ESTRUCTURAS ESPECIALES dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Glosario: 5 términos que defines sin diccionario.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 2:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 3:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n· Memorizar sin implementar ni medir en código o terminal.\n· Copiar snippets sin saber qué patrón o complejidad demuestran.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume ESTRUCTURAS ESPECIALES en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar ESTRUCTURAS ESPECIALES es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
  ...
  },
{
    ...
    description: "Integrando todo en sistemas de producción e Inteligencia Artificial. Clase autocontenida (~60 min): teoría ampliada, código, 12 preguntas y guía para grabar APLICACIONES EN EL MUNDO REAL.",
    items: [
    ...
    content: "## 📘 Clase completa — APLICACIONES EN EL MUNDO REAL\n**Duración sugerida al grabar:** 55–65 minutos (intro + 10 bloques + industria + cierre + quiz).\n\n## Introducción (8–10 min)\n\nIntegrando todo en sistemas de producción e Inteligencia Artificial. La teoría cobra vida en sistemas reales. Las bases de datos SQL usan índices basados en Árboles B+ para evitar barridos lineales secuenciales de disco. Los sistemas de archivos Linux usan Inodos para indexar el almacenamiento físico y permisos de archivos. El enrutamiento en redes (como OSPF) corre Dijkstra en cada router para hallar la ruta de menor latencia. Los motores de juegos clásicos de tablero (ajedrez, damas) usan árboles Minimax con poda Alfa-Beta para evaluar jugadas y respuestas del contrincante.\n\nMaterial **gratuito y autocontenido** QuimiSell: estudia, repasa y graba sin pagar plataformas externas. Trata este módulo como un **micro-curso** completo sobre el tema.\n\n## Objetivos de aprendizaje\n\n· Índices de DB: Cómo SQL usa B+ Trees para buscar en terabytes.\n· Sistemas de Archivos: Inodos y estructuras jerárquicas en Linux.\n· Redes: Algoritmos de enrutamiento OSPF y tablas ARP.\n· IA Básica: Árboles de decisión y el algoritmo Minimax para juegos.\n· Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n· Errores frecuentes de principiantes y cómo evitarlos en producción.\n· Checklist de repaso previo a evaluación o grabación de clase.\n· Mapa mental de APLICACIONES EN EL MUNDO REAL.\n· Preguntas tipo entrevista técnica.\n· Glosario: 5 términos que defines sin diccionario.\n· Explicar el tema en 3 minutos sin apuntes (Feynman).\n· Aprobar ≥70% de la autoevaluación (12 preguntas).\n· Conectar con un caso real de industria o proyecto propio.\n\n## Bloque 1 — Índices de DB: Cómo SQL usa B+ Trees para buscar en terabytes.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Índices de DB: Cómo SQL usa B+ Trees para buscar en terabytes.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Índices de DB: Cómo SQL usa B+ Trees para buscar en terabytes.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 2 — Sistemas de Archivos: Inodos y estructuras jerárquicas en Linux.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Sistemas de Archivos: Inodos y estructuras jerárquicas en Linux.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Sistemas de Archivos: Inodos y estructuras jerárquicas en Linux.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 3 — Redes: Algoritmos de enrutamiento OSPF y tablas ARP.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Redes: Algoritmos de enrutamiento OSPF y tablas ARP.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Redes: Algoritmos de enrutamiento OSPF y tablas ARP.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 4 — IA Básica: Árboles de decisión y el algoritmo Minimax para juegos.\n\nTiempo sugerido al grabar: **7–9 minutos**. «IA Básica: Árboles de decisión y el algoritmo Minimax para juegos.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «IA Básica: Árboles de decisión y el algoritmo Minimax para juegos.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 5 — Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Aplicación directa en proyectos reales y entrevistas técnicas de ingeniería.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 6 — Errores frecuentes de principiantes y cómo evitarlos en producción.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Errores frecuentes de principiantes y cómo evitarlos en producción.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Errores frecuentes de principiantes y cómo evitarlos en producción.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 7 — Checklist de repaso previo a evaluación o grabación de clase.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Checklist de repaso previo a evaluación o grabación de clase.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Checklist de repaso previo a evaluación o grabación de clase.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 8 — Mapa mental de APLICACIONES EN EL MUNDO REAL.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Mapa mental de APLICACIONES EN EL MUNDO REAL.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Mapa mental de APLICACIONES EN EL MUNDO REAL.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 9 — Preguntas tipo entrevista técnica.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Preguntas tipo entrevista técnica.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Preguntas tipo entrevista técnica.» a un sistema conocido (API, app, red, BD).\n\n## Bloque 10 — Glosario: 5 términos que defines sin diccionario.\n\nTiempo sugerido al grabar: **7–9 minutos**. «Glosario: 5 términos que defines sin diccionario.» es esencial en APLICACIONES EN EL MUNDO REAL dentro de estructuras de datos, complejidad y diseño de algoritmos escalables.\n\n**Qué debes dominar:** definición clara, cuándo aplica, cuándo no, y alternativas. En entrevistas técnicas suelen preguntar variaciones de este punto.\n\n**Cómo enseñarlo:** (1) intuición con ejemplo en pizarra; (2) demo con el snippet del módulo; (3) discusión de trade-offs (tiempo, memoria, seguridad, mantenibilidad). Haz una pausa y plantea una pregunta antes de responderla — mantiene el ritmo de una hora de clase.\n\n**Pausa activa:** el estudiante escribe una frase aplicando «Glosario: 5 términos que defines sin diccionario.» a un sistema conocido (API, app, red, BD).\n\n## Aplicación en la industria (10 min)\n\n**Caso 1:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 2:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\n**Caso 3:** PostgreSQL y MySQL indexan con B+ Trees: búsquedas O(log n) en tablas gigantes.\n\nAl grabar, desarrolla **un** caso con contexto, problema, solución y consecuencias de ignorar la teoría.\n\n## Errores frecuentes (5 min)\n\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n· Confundir best case con peor caso al estimar rendimiento.\n· No vincular el tema con un proyecto real que el estudiante recuerde.\n\n## Guía para grabar (5 min)\n\n1. Hook (30 s) · 2. Objetivos (1 min) · 3. Bloques teóricos (35–40 min) · 4. Caso industria (8 min) · 5. Errores (4 min) · 6. Cierre + quiz (3 min).\n\nUsa estos apuntes como guion; no leas literal. Tu claridad y ejemplos valen más que producción cara.\n\n## Cierre (5 min)\n\nResume APLICACIONES EN EL MUNDO REAL en cinco frases. Completa la autoevaluación. Repasa en 7 días (repaso espaciado). «Dominar APLICACIONES EN EL MUNDO REAL es saber cuándo aplicarlo en sistemas reales — aquí tienes teoría, código y práctica gratis.»",
